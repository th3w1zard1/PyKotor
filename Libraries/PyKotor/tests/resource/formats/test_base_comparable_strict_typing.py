...
class TestComparable(ComparableMixin):
    """Test class for ComparableMixin."""
...
class TestComparableMixinStrictTyping:
    ...
    def test_compare_uses_class_variable_directly(self):
        ...
        obj1 = TestComparable(1, "test", ["a", "b"], {"tag1"})
        obj2 = TestComparable(1, "test", ["a", "b"], {"tag1"})
    ...
    def test_compare_uses_getattr_for_field_values(self):
        ...
        obj1 = TestComparable(1, "test1", ["a"], {"tag1"})
        obj2 = TestComparable(2, "test2", ["b"], {"tag2"})
    ...
    def test_compare_sequence_fields(self):
        ...
        obj1 = TestComparable(1, "test", ["a", "b"], set())
        obj2 = TestComparable(1, "test", ["a", "b"], set())
    ...
    def test_compare_set_fields(self):
        ...
        obj1 = TestComparable(1, "test", [], {"tag1", "tag2"})
        obj2 = TestComparable(1, "test", [], {"tag2", "tag1"})  # Same tags, different order
    ...
    def test_compare_missing_field_handles_gracefully(self):
        ...
        obj1 = TestComparable(1, "test", [], set())
        obj2 = TestComparable(1, "test", [], set())
