"""High-granularity ModuleKit (implicit-kit) roundtrip tests for PyKotor CLI indoor commands.
...
- Use PyKotor CLI commands (via `pykotor.cli.dispatch.cli_main`) so behavior matches the CLI.
"""
