...
void main() {
	object oKas_rulan_party0_jump = GetObjectByTag("kas_rulan_party0_jump", 0);
	object oKas_rulan_party1_jump = GetObjectByTag("kas_rulan_party1_jump", 0);
	object oKas_rulan_party2_jump = GetObjectByTag("kas_rulan_party2_jump", 0);
	sub1(2.8);
