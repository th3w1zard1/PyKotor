	...
	if ((nGlobal > (-1))) {
		...
		if ((float18 > 3800.0)) {
			...
			if ((nGlobal < 6)) {
				...
				SetGlobalBoolean("TAR_SWOOP_RUN", 1);
				AssignCommand(GetFirstPC(), DelayCommand(3.0, StartNewModule("tar_m03af", "tar03_wpmechanic", "", "", "", "", "", "")));
			}
		}
		else {
			...
			SetGlobalNumber("TAR_SWOOP_MIN", (int33 / 60));
			SetGlobalNumber("TAR_SWOOP_SEC", FloatToInt((((IntToFloat(int33) / 60.0) - (int33 / 60)) * 60.0)));
			SetGlobalNumber("TAR_SWOOP_MSEC", FloatToInt(((float16 - int33) * 100.0)));
			if ((((sub1(GetGlobalNumber("TAR_SWOOP_MIN"), GetGlobalNumber("TAR_SWOOP_SEC"), GetGlobalNumber("TAR_SWOOP_MSEC")) > sub1(GetGlobalNumber("TAR_SWOOP_MIN_BEAT"), GetGlobalNumber("TAR_SWOOP_SEC_BEAT"), GetGlobalNumber("TAR_SWOOP_MSEC_BEAT"))) && (GetGlobalNumber("Tar_SwoopRaceCounter") == 5)) && (!GetGlobalBoolean("TAR_RACEMOVIE")))) {
				SetGlobalBoolean("TAR_RACEMOVIE", 1);
				sub2(("PLAYING NEW MOVIE..." + IntToString(GetGlobalBoolean("TAR_RACEMOVIE"))), 5, 5, 5.0);
