"""Test Installation class using create_installation helper.

This test mirrors test_installation.py but uses create_installation to create
a mock installation instead of requiring a real KOTOR installation.
"""
...
class TestInstallationWithCreateInstallation(TestCase):
    """Test Installation class using create_installation helper."""

    @classmethod
    def setUpClass(cls):
        """Create a mock installation using create_installation."""
        ...
        cls.installation = Installation(cls.install_path)
    ...
    def _assert_from_path_tests(
        ...
        """Helper to assert resource lookup results."""
