"""Port of PrunedDepthFirstAdapter.java from DeNCS.

See vendor/DeNCS/procyon/com/knights2end/nwscript/decomp/analysis/PrunedDepthFirstAdapter.java
"""
...
class PrunedDepthFirstAdapter(AnalysisAdapter):
    ...
    This is similar to PrunedReversedDepthFirstAdapter but iterates
    children in forward order instead of reverse.
    """
    ...
    def case_a_program(self, node: AProgram):
        ...
        # Forward iteration (unlike reversed in PrunedReversedDepthFirstAdapter)
    ...
    def case_a_subroutine(self, node: ASubroutine):
        ...
        # CommandBlock before Return (forward order)
    ...
    # Command detail nodes - no children traversal
