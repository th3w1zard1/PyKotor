...
**Engine Usage**: Defines ammunition [types](GFF-File-Format#gff-data-types) for ranged weapons, including their [models](MDL-MDX-File-Format) and sound effects. The engine uses this [file](GFF-File-Format) when loading items to determine ammunition properties for ranged weapons.
...
- [`vendor/reone/src/libs/game/object/item.cpp:164-171`](https://github.com/th3w1zard1/reone/blob/master/src/libs/game/object/item.cpp#L164-L171) - Ammunition [type](GFF-File-Format#gff-data-types) loading from [2DA](2DA-File-Format)
