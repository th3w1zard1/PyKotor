...
**Engine Usage**: Maps portrait IDs to portrait image ResRefs for character selection screens and character sheets. The engine uses this [file](GFF-File-Format) to display character portraits in the UI.
