...
|------------|------|-------------|
| `label` | [string](GFF-File-Format#gff-data-types) | Visual effect label |
| `name` | [StrRef](TLK-File-Format#string-references-strref) | [string](GFF-File-Format#gff-data-types) reference for effect name |
...
| `impacttype` | Integer | Impact [type](GFF-File-Format#gff-data-types) identifier |
...
| `lightcolor` | [string](GFF-File-Format#gff-data-types) | Light [color](GFF-File-Format#color) RGB [values](GFF-File-Format#gff-data-types) |
...
| `lightshadowcolor` | [string](GFF-File-Format#gff-data-types) | Light shadow [color](GFF-File-Format#color) RGB [values](GFF-File-Format#gff-data-types) |
...
| `lightshadowpulsecolor` | [string](GFF-File-Format#gff-data-types) | Light shadow pulse [color](GFF-File-Format#color) RGB [values](GFF-File-Format#gff-data-types) |
...
| `lightshadowpulsefadecolor` | [string](GFF-File-Format#gff-data-types) | Light shadow pulse fade [color](GFF-File-Format#color) RGB [values](GFF-File-Format#gff-data-types) |
...
| `lightshadowpulsefadepulsecolor` | [string](GFF-File-Format#gff-data-types) | Light shadow pulse fade pulse [color](GFF-File-Format#color) RGB [values](GFF-File-Format#gff-data-types) |
...
| `lightshadowpulsefadepulsefadecolor` | [string](GFF-File-Format#gff-data-types) | Light shadow pulse fade pulse fade [color](GFF-File-Format#color) RGB [values](GFF-File-Format#gff-data-types) |
...
- [`Libraries/PyKotor/src/pykotor/extract/twoda.py:593`](https://github.com/th3w1zard1/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/extract/twoda.py#L593) - [GFF](GFF-File-Format) [field](GFF-File-Format#file-structure-overview) mapping: "VisualType" -> [visualeffects.2da](2DA-visualeffects)
