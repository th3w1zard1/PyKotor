...
**Source:** This documentation is extracted from the official BioWare Aurora Engine Encounter Format PDF, archived in [`vendor/xoreos-docs/specs/bioware/Encounter_Format.pdf`](https://github.com/th3w1zard1/xoreos-docs/blob/master/specs/bioware/Encounter_Format.pdf). The original documentation was published on the now-defunct nwn.bioware.com developer site.
