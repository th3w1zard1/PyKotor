...
**Mod_Area_list Struct [fields](GFF-File-Format#file-structure-overview):**

- `Area_Name` ([ResRef](GFF-File-Format#gff-data-types)): [Area](GFF-File-Format#are-area) [ResRef](GFF-File-Format#gff-data-types) ([ARE](GFF-File-Format#are-area) [file](GFF-File-Format))
...
- Additional [bits](GFF-File-Format#gff-data-types) for future expansions
...
| [field](GFF-File-Format#file-structure-overview) | [type](GFF-File-Format#gff-data-types) | Description |
| ----- | ---- | ----------- |
| `Mod_StartMovie` | [ResRef](GFF-File-Format#gff-data-types) | Starting movie [file](GFF-File-Format) |
| `Mod_Hak` | [CExoString](GFF-File-Format#gff-data-types) | Required HAK [file](GFF-File-Format) list |
...
- Setup persistent [data](GFF-File-Format#file-structure-overview) [structures](GFF-File-Format#file-structure-overview)
- Load saved state
