...
- Note that fR, fG, and fB [ARE](GFF-File-Format#are-area) normalized values.
- The default values [ARE](GFF-File-Format#are-area) an immediate cut in from black.
...
- Note that fR, fG, and fB [ARE](GFF-File-Format#are-area) normalized values.
- The default values [ARE](GFF-File-Format#are-area) an immediate cut to from black.
