...
**Source:** This documentation is extracted from the official BioWare Aurora Engine DoorPlaceableGFF PDF, archived in [`vendor/xoreos-docs/specs/bioware/DoorPlaceableGFF.pdf`](https://github.com/th3w1zard1/xoreos-docs/blob/master/specs/bioware/DoorPlaceableGFF.pdf). The original documentation was published on the now-defunct nwn.bioware.com developer site.
