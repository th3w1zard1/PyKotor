...
**Engine Usage**: Maps item property [values](GFF-File-Format#gff-data-types) to saving throw [types](GFF-File-Format#gff-data-types). The engine uses this [file](GFF-File-Format) to determine saving throw calculations for item properties.
...
| Additional columns | Various | Saving throw [type](GFF-File-Format#gff-data-types) mappings |
