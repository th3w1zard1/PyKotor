...
[PLT files](PLT-File-Format) work in conjunction with external palette files (`.pal` [files](GFF-File-Format)) that contain the actual [color](GFF-File-Format#color) [values](GFF-File-Format#gff-data-types). The [PLT file](PLT-File-Format) itself stores:
...
3. Uses the [color](GFF-File-Format#color) [index](2DA-File-Format#row-labels) from the [PLT file](PLT-File-Format) to retrieve the final [color](GFF-File-Format#color) [value](GFF-File-Format#gff-data-types)

**Reference**: [`vendor/xoreos-docs/specs/torlack/plt.html`](https://github.com/th3w1zard1/xoreos-docs/blob/master/specs/torlack/plt.html) - Tim Smith (Torlack)'s reverse-engineered [PLT](PLT-File-Format) [format](GFF-File-Format) documentation
...
1. **Get Palette Group**: Read the palette group index (0-9) from the [PLT](PLT-File-Format) pixel [data](GFF-File-Format#file-structure-overview)
...
3. **Select Palette Row**: Use the palette [index](2DA-File-Format#row-labels) to select a row in the corresponding palette [file](GFF-File-Format)
4. **Get Color [index](2DA-File-Format#row-labels)**: Read the [color](GFF-File-Format#color) index (0-255) from the [PLT](PLT-File-Format) pixel [data](GFF-File-Format#file-structure-overview)
5. **Retrieve [color](GFF-File-Format#color)**: Use the [color](GFF-File-Format#color) [index](2DA-File-Format#row-labels) to get the final RGB [color](GFF-File-Format#color) [value](GFF-File-Format#gff-data-types) from the selected palette row
...
- The RGB [value](GFF-File-Format#gff-data-types) at that [position](MDL-MDX-File-Format#node-header) becomes the pixel's [color](GFF-File-Format#color)

**Reference**: [`vendor/xoreos-docs/specs/torlack/plt.html`](https://github.com/th3w1zard1/xoreos-docs/blob/master/specs/torlack/plt.html) - [color](GFF-File-Format#color) resolution example
...
| --------- | ------- | ------ | ---- | ---------------------------------------------- |
| Signature | [[char](GFF-File-Format#gff-data-types)][GFF-File-Format#char](4) | 0 (0x0000) | 4    | Always `"PLT "` (space-padded)                  |
| Version   | [[char](GFF-File-Format#gff-data-types)][GFF-File-Format#char](4) | 4 (0x0004) | 4    | Always `"V1  "` (space-padded)                  |
| Unknown   | [uint32](GFF-File-Format#gff-data-types)  | 8 (0x0008) | 4    | Unknown [value](GFF-File-Format#gff-data-types)                                  |
| Unknown   | [uint32](GFF-File-Format#gff-data-types)  | 12 (0x000C) | 4    | Unknown [value](GFF-File-Format#gff-data-types)                                  |
...
**Reference**: [`vendor/xoreos-docs/specs/torlack/plt.html`](https://github.com/th3w1zard1/xoreos-docs/blob/master/specs/torlack/plt.html) - [PLT file](PLT-File-Format) [header](GFF-File-Format#file-header) [structure](GFF-File-Format#file-structure-overview)

### Pixel [data](GFF-File-Format#file-structure-overview)

Following the [header](GFF-File-Format#file-header), pixel [data](GFF-File-Format#file-structure-overview) is stored as an [array](2DA-File-Format) of 2-[byte](GFF-File-Format#gff-data-types) [structures](GFF-File-Format#file-structure-overview). There [ARE](GFF-File-Format#are-area) `width × height` pixel entries.

Each pixel entry is 2 bytes:

| Name              | [type](GFF-File-Format#data-types)   | [offset](GFF-File-Format#file-structure-overview) | [size](GFF-File-Format#file-structure-overview) | Description                                    |
| ----------------- | ------ | ------ | ---- | ---------------------------------------------- |
| [color](GFF-File-Format#color) [index](2DA-File-Format#row-labels)       | [uint8](GFF-File-Format#gff-data-types)  | 0 (0x0000) | 1    | [color](GFF-File-Format#color) index (0-255) within the selected palette |
| Palette Group [index](2DA-File-Format#row-labels) | [uint8](GFF-File-Format#gff-data-types) | 1 (0x0001) | 1    | Palette group index (0-9)                      |

**Pixel [data](GFF-File-Format#file-structure-overview) Layout**: Pixels [ARE](GFF-File-Format#are-area) stored row by row, left to right, top to bottom. The total pixel [data](GFF-File-Format#file-structure-overview) [size](GFF-File-Format#file-structure-overview) is `width × height × 2` bytes.

**Reference**: [`vendor/xoreos-docs/specs/torlack/plt.html`](https://github.com/th3w1zard1/xoreos-docs/blob/master/specs/torlack/plt.html) - Pixel [data](GFF-File-Format#file-structure-overview) [structure](GFF-File-Format#file-structure-overview)
...
**Reference**: [`vendor/xoreos-docs/specs/torlack/plt.html`](https://github.com/th3w1zard1/xoreos-docs/blob/master/specs/torlack/plt.html) - Complete [PLT](PLT-File-Format) [format](GFF-File-Format) specification  
...
This documentation aims to provide a comprehensive overview of the [PLT file](PLT-File-Format) [format](GFF-File-Format), focusing on the detailed [file](GFF-File-Format) [structure](GFF-File-Format#file-structure-overview) and palette system used in Neverwinter Nights (part of the BioWare Aurora engine family).
