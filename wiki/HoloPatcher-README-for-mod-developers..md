_This page explains how to create a mod with HoloPatcher. If you are an end user you may be looking for [How to Use HoloPatcher](https://github.com/th3w1zard1/PyKotor/wiki/Installing-Mods-with-HoloPatcher)_
...
This is a TSLPatcher feature that was [not documented in the TSLPatcher readme.](https://github.com/th3w1zard1/PyKotor/wiki/TSLPatcher's-Official-Readme). We can only guess why this is. The only known uses we know about are [Stoffe's HLFP mod](https://deadlystream.com/files/file/832-high-level-force-powers/) and some starwarsknights/lucasforums archives on waybackmachine pointing to files that are unavailable.
