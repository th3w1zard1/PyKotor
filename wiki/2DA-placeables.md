...
**Row [index](2DA-File-Format#row-labels)**: Placeable [type](GFF-File-Format#data-types) ID (integer)

**Column [structure](GFF-File-Format#file-structure)**:

| Column Name | [type](GFF-File-Format#data-types) | Description |
|------------|------|-------------|
| `label` | String (optional) | Placeable [type](GFF-File-Format#data-types) label |
| `modelname` | ResRef (optional) | 3D [model](MDL-MDX-File-Format) [ResRef](GFF-File-Format#resref) |
| `strref` | Integer | [string](GFF-File-Format#cexostring) reference for placeable name |
...
| `lightcolor` | String (optional) | Light [color](GFF-File-Format#color) RGB [values](GFF-File-Format#data-types) |
| `lightoffsetx` | String (optional) | Light X [offset](GFF-File-Format#file-structure) |
| `lightoffsety` | String (optional) | Light Y [offset](GFF-File-Format#file-structure) |
| `lightoffsetz` | String (optional) | Light Z [offset](GFF-File-Format#file-structure) |
| `lowgore` | String (optional) | Low gore [model](MDL-MDX-File-Format) [ResRef](GFF-File-Format#resref) |
| `noncull` | Boolean | Whether to disable culling |
| `preciseuse` | Boolean | Whether precise use is enabled |
| `shadowsize` | Boolean | Whether shadow [size](GFF-File-Format#file-structure) is enabled |
...
The complete column [structure](GFF-File-Format#file-structure) is defined in reone's placeables parser:

- `label`: Optional label [string](GFF-File-Format#cexostring)
- `modelname`: 3D [model](MDL-MDX-File-Format) [ResRef](GFF-File-Format#resref)
- `strref`: [string](GFF-File-Format#cexostring) reference for placeable name
- `bodybag`: Boolean - whether placeable can contain bodies
- `canseeheight`: Float - can-see height for line of sight
- `hitcheck`: Boolean - whether hit detection is enabled
- `hostile`: Boolean - whether placeable is hostile
- `ignorestatichitcheck`: Boolean - whether to ignore static hit checks
- `lightcolor`: Optional [string](GFF-File-Format#cexostring) - light [color](GFF-File-Format#color) RGB [values](GFF-File-Format#data-types)
- `lightoffsetx`: Optional [string](GFF-File-Format#cexostring) - light X [offset](GFF-File-Format#file-structure)
- `lightoffsety`: Optional [string](GFF-File-Format#cexostring) - light Y [offset](GFF-File-Format#file-structure)
- `lightoffsetz`: Optional [string](GFF-File-Format#cexostring) - light Z [offset](GFF-File-Format#file-structure)
- `lowgore`: Optional [string](GFF-File-Format#cexostring) - low gore [model](MDL-MDX-File-Format) [ResRef](GFF-File-Format#resref)
- `noncull`: Boolean - whether to disable culling
- `preciseuse`: Boolean - whether precise use is enabled
- `shadowsize`: Boolean - whether shadow [size](GFF-File-Format#file-structure) is enabled
...
- [`Libraries/PyKotor/src/pykotor/extract/twoda.py:170`](https://github.com/th3w1zard1/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/extract/twoda.py#L170) - [model](MDL-MDX-File-Format) [ResRef](GFF-File-Format#resref) column definition for [placeables.2da](2DA-placeables) (K1: modelname)
...
- [`Libraries/PyKotor/src/pykotor/extract/twoda.py:349`](https://github.com/th3w1zard1/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/extract/twoda.py#L349) - [model](MDL-MDX-File-Format) [ResRef](GFF-File-Format#resref) column definition for [placeables.2da](2DA-placeables) (K2: modelname)
...
- [`Libraries/PyKotor/src/pykotor/extract/twoda.py:542`](https://github.com/th3w1zard1/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/extract/twoda.py#L542) - [GFF](GFF-File-Format) [field](GFF-File-Format#file-structure) mapping: "Appearance" -> [placeables.2da](2DA-placeables)
