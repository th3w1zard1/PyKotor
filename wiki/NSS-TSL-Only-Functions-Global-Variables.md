...
- DJS-OEI 2/3/2004
- Decreases the [value](GFF-File-Format#gff-data-types) of the given global number by the given amount.
...
- DJS-OEI 2/3/2004
- Increases the [value](GFF-File-Format#gff-data-types) of the given global number by the given amount.
- This function only works with Number [type](GFF-File-Format#data-types) globals, not booleans. It
