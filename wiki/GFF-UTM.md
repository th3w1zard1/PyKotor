...
UTM [files](GFF-File-Format) define [merchant templates](GFF-File-Format#utm-merchant) with inventory lists and merchant-specific properties.

**Official Bioware Documentation:** For the authoritative Bioware Aurora Engine Store [format](GFF-File-Format) specification, see [Bioware Aurora Store Format](Bioware-Aurora-Store).
