...
[KEY files](KEY-File-Format) map resource names ([ResRefs](GFF-File-Format#gff-data-types)) and [types](GFF-File-Format#gff-data-types) to specific locations within [BIF archives](BIF-File-Format). KotOR uses [`chitin.key`](KEY-File-Format) as the main [KEY file](KEY-File-Format) which references all game [BIF files](BIF-File-Format).
...
- [BIF File Format](BIF-File-Format) - Archive [format](GFF-File-Format) indexed by [KEY](KEY-File-Format) [files](GFF-File-Format)
...
The [file](GFF-File-Format) [header](GFF-File-Format#file-header) is 64 bytes in [size](GFF-File-Format#file-structure-overview):
...
| ------------------- | ------- | ------ | ---- | ---------------------------------------------- |
| [file](GFF-File-Format) [type](GFF-File-Format#gff-data-types)           | [[char](GFF-File-Format#gff-data-types)][GFF-File-Format#char](4) | 0 (0x00) | 4    | Always `"KEY "` (space-padded)                 |
| [file](GFF-File-Format) Version        | [[char](GFF-File-Format#gff-data-types)][GFF-File-Format#char](4) | 4 (0x04) | 4    | `"V1  "` or `"V1.1"`                           |
| [BIF](BIF-File-Format) [count](GFF-File-Format#file-structure-overview)           | [uint32](GFF-File-Format#gff-data-types)  | 8 (0x08) | 4    | Number of [BIF files](BIF-File-Format) referenced                 |
| [KEY](KEY-File-Format) [count](GFF-File-Format#file-structure-overview)           | [uint32](GFF-File-Format#gff-data-types)  | 12 (0x0C) | 4    | Number of resource entries                     |
| [offset](GFF-File-Format#file-structure-overview) to [file](GFF-File-Format) Table | [uint32](GFF-File-Format#gff-data-types) | 16 (0x10) | 4    | [offset](GFF-File-Format#file-structure-overview) to [BIF file](BIF-File-Format) entries [array](2DA-File-Format)               |
| [offset](GFF-File-Format#file-structure-overview) to [KEY](KEY-File-Format) Table | [uint32](GFF-File-Format#gff-data-types) | 20 (0x14) | 4    | [offset](GFF-File-Format#file-structure-overview) to resource entries [array](2DA-File-Format)               |
...
| Reserved            | [[byte](GFF-File-Format#gff-data-types)][GFF-File-Format#byte](32) | 32 (0x20) | 32   | Padding (usually zeros)                        |

**Note on [header](GFF-File-Format#file-header) Variations**: [`vendor/xoreos-docs/specs/torlack/key.html`](https://github.com/th3w1zard1/xoreos-docs/blob/master/specs/torlack/key.html) (Tim Smith/Torlack's reverse-engineered documentation) shows the [header](GFF-File-Format#file-header) ending at [offset](GFF-File-Format#file-structure-overview) 0x0040 with unknown [values](GFF-File-Format#gff-data-types) at [offset](GFF-File-Format#file-structure-overview) 0x0018. The [structure](GFF-File-Format#file-structure-overview) shown here (with Build Year/Day and Reserved [fields](GFF-File-Format#file-structure-overview)) matches the actual KotOR [KEY file](KEY-File-Format) [format](GFF-File-Format).
...
**Reference**: [`vendor/xoreos-docs/specs/torlack/key.html`](https://github.com/th3w1zard1/xoreos-docs/blob/master/specs/torlack/key.html) - Tim Smith (Torlack)'s reverse-engineered [KEY](KEY-File-Format) [format](GFF-File-Format) documentation (may show variant [header](GFF-File-Format#file-header) [structure](GFF-File-Format#file-structure-overview))
...
| Name            | [type](GFF-File-Format#gff-data-types)   | [offset](GFF-File-Format#file-structure-overview) | [size](GFF-File-Format#file-structure-overview) | Description                                                      |
| --------------- | ------ | ------ | ---- | ---------------------------------------------------------------- |
| [file](GFF-File-Format) [size](GFF-File-Format#file-structure-overview)       | [uint32](GFF-File-Format#gff-data-types) | 0 (0x00) | 4    | [size](GFF-File-Format#file-structure-overview) of [BIF file](BIF-File-Format) on disk                                         |
| Filename [offset](GFF-File-Format#file-structure-overview) | [uint32](GFF-File-Format#gff-data-types) | 4 (0x04) | 4    | [offset](GFF-File-Format#file-structure-overview) into filename table                                       |
...
| [flag](GFF-File-Format#gff-data-types) [value](GFF-File-Format#gff-data-types) | Meaning | Description |
| ---------- | ------- | ----------- |
...
The filename table contains [null-terminated](https://en.cppreference.com/w/c/string/byte) [strings](GFF-File-Format#gff-data-types):

| Name      | [type](GFF-File-Format#gff-data-types)   | Description                                                      |
| --------- | ------ | ---------------------------------------------------------------- |
| Filenames | [char](GFF-File-Format#gff-data-types)[] | [null-terminated](https://en.cppreference.com/w/c/string/byte) [BIF](BIF-File-Format) filenames (e.g., "[data](GFF-File-Format#file-structure-overview)/[models](MDL-MDX-File-Format).bif")         |
...
| Resource [type](GFF-File-Format#gff-data-types) | [uint16](GFF-File-Format#gff-data-types) | 16 (0x10) | 2    | Resource [type](GFF-File-Format#gff-data-types) identifier                                         |
...
**Critical [structure](GFF-File-Format#file-structure-overview) Packing Note:**

The [KEY](KEY-File-Format) entry [structure](GFF-File-Format#file-structure-overview) must use **[byte](GFF-File-Format#gff-data-types) or word alignment** (1-[byte](GFF-File-Format#gff-data-types) or 2-[byte](GFF-File-Format#gff-data-types) packing). If the [structure](GFF-File-Format#file-structure-overview) is packed with 4-[byte](GFF-File-Format#gff-data-types) or 8-[byte](GFF-File-Format#gff-data-types) alignment, the `uint32` at [offset](GFF-File-Format#file-structure-overview) 0x0012 (18) will be incorrectly placed at [offset](GFF-File-Format#file-structure-overview) 0x0014 (20), causing incorrect resource ID decoding.

On non-Intel platforms, this alignment requirement may cause alignment faults unless the compiler provides an "unaligned" [type](GFF-File-Format#gff-data-types) or special care is taken when accessing the `uint32` [field](GFF-File-Format#file-structure-overview). The [structure](GFF-File-Format#file-structure-overview) should be explicitly packed to ensure the `uint32` starts at [offset](GFF-File-Format#file-structure-overview) 18 rather than being aligned to a 4-[byte](GFF-File-Format#gff-data-types) boundary.
...
The Resource ID [field](GFF-File-Format#file-structure-overview) encodes both the [BIF](BIF-File-Format) [index](2DA-File-Format#row-labels) and resource [index](2DA-File-Format#row-labels) within that [BIF](BIF-File-Format):

- **[bits](GFF-File-Format#gff-data-types) 31-20**: [BIF](BIF-File-Format) Index (top 12 [bits](GFF-File-Format#gff-data-types)) - [index](2DA-File-Format#row-labels) into [file](GFF-File-Format) table
- **[bits](GFF-File-Format#gff-data-types) 19-0**: Resource Index (bottom 20 [bits](GFF-File-Format#gff-data-types)) - [index](2DA-File-Format#row-labels) within the [BIF file](BIF-File-Format)
...
- Maximum [BIF files](BIF-File-Format): 4,096 (12-[bit](GFF-File-Format#gff-data-types) [BIF](BIF-File-Format) [index](2DA-File-Format#row-labels))
- Maximum resources per [BIF](BIF-File-Format): 1,048,576 (20-[bit](GFF-File-Format#gff-data-types) resource [index](2DA-File-Format#row-labels))
...
The encoding allows a single 32-[bit](GFF-File-Format#gff-data-types) integer to precisely locate any resource in the entire [BIF](BIF-File-Format) system.
...
This documentation aims to provide a comprehensive overview of the KotOR [KEY file](KEY-File-Format) [format](GFF-File-Format), focusing on the detailed [file](GFF-File-Format) [structure](GFF-File-Format#file-structure-overview) and [data](GFF-File-Format#file-structure-overview) [formats](GFF-File-Format) used within the games.
