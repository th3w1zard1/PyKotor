# KotOR [NSS files](NSS-File-Format) format Documentation
...
- [KotOR NSS File Format Documentation](#kotor-nss-files-format-documentation)
  ...
  - [Shared Functions (K1 \& TSL)](#shared-functions-k1--tsl)
    - [Abilities and Stats](#abilities-and-stats)
      - [`GetAbilityModifier(nAbility, oCreature)` - Routine 331](NSS-Shared-Functions-Abilities-and-Stats#getabilitymodifier)
      - [`GetAbilityScore(oCreature, nAbilityType)` - Routine 139](NSS-Shared-Functions-Abilities-and-Stats#getabilityscore)
      - [`GetNPCSelectability(nNPC)` - Routine 709](NSS-Shared-Functions-Abilities-and-Stats#getnpcselectability)
      - [`SetNPCSelectability(nNPC, nSelectability)` - Routine 708](NSS-Shared-Functions-Abilities-and-Stats#setnpcselectability)
      - [`SWMG_StartInvulnerability(oFollower)` - Routine 666](NSS-Shared-Functions-Abilities-and-Stats#swmgstartinvulnerability)
    - [Actions](#actions)
      - [`ActionAttack(oAttackee, bPassive)` - Routine 37](NSS-Shared-Functions-Actions#actionattack)
      - [`ActionBarkString(strRef)` - Routine 700](NSS-Shared-Functions-Actions#actionbarkstring)
      - [`ActionCastFakeSpellAtLocation(nSpell, lTarget, nProjectilePathType)` - Routine 502](NSS-Shared-Functions-Actions#actioncastfakespellatlocation)
      - [`ActionCastFakeSpellAtObject(nSpell, oTarget, nProjectilePathType)` - Routine 501](NSS-Shared-Functions-Actions#actioncastfakespellatobject)
      - [`ActionCastSpellAtLocation(nSpell, lTargetLocation, nMetaMagic, bCheat, nProjectilePathType, bInstantSpell)` - Routine 234](NSS-Shared-Functions-Actions#actioncastspellatlocation)
      - [`ActionCastSpellAtObject(nSpell, oTarget, nMetaMagic, bCheat, nDomainLevel, nProjectilePathType, bInstantSpell)` - Routine 48](NSS-Shared-Functions-Actions#actioncastspellatobject)
      - [`ActionCloseDoor(oDoor)` - Routine 44](NSS-Shared-Functions-Actions#actionclosedoor)
      - [`ActionDoCommand(aActionToDo)` - Routine 294](NSS-Shared-Functions-Actions#actiondocommand)
      - [`ActionEquipItem(oItem, nInventorySlot, bInstant)` - Routine 32](NSS-Shared-Functions-Actions#actionequipitem)
      - [`ActionEquipMostDamagingMelee(oVersus, bOffHand)` - Routine 399](NSS-Shared-Functions-Actions#actionequipmostdamagingmelee)
      - [`ActionEquipMostDamagingRanged(oVersus)` - Routine 400](NSS-Shared-Functions-Actions#actionequipmostdamagingranged)
      - [`ActionFollowLeader()` - Routine 730](NSS-Shared-Functions-Actions#actionfollowleader)
      - [`ActionForceFollowObject(oFollow, fFollowDistance)` - Routine 167](NSS-Shared-Functions-Actions#actionforcefollowobject)
      - [`ActionForceMoveToLocation(lDestination, bRun, fTimeout)` - Routine 382](NSS-Shared-Functions-Actions#actionforcemovetolocation)
      - [`ActionForceMoveToObject(oMoveTo, bRun, fRange, fTimeout)` - Routine 383](NSS-Shared-Functions-Actions#actionforcemovetoobject)
      - [`ActionGiveItem(oItem, oGiveTo)` - Routine 135](NSS-Shared-Functions-Actions#actiongiveitem)
      - [`ActionInteractObject(oPlaceable)` - Routine 329](NSS-Shared-Functions-Actions#actioninteractobject)
      - [`ActionJumpToLocation(lLocation)` - Routine 214](NSS-Shared-Functions-Actions#actionjumptolocation)
      - [`ActionJumpToObject(oToJumpTo, bWalkStraightLineToPoint)` - Routine 196](NSS-Shared-Functions-Actions#actionjumptoobject)
      - [`ActionLockObject(oTarget)` - Routine 484](NSS-Shared-Functions-Actions#actionlockobject)
      - [`ActionMoveAwayFromLocation(lMoveAwayFrom, bRun, fMoveAwayRange)` - Routine 360](NSS-Shared-Functions-Actions#actionmoveawayfromlocation)
      - [`ActionMoveAwayFromObject(oFleeFrom, bRun, fMoveAwayRange)` - Routine 23](NSS-Shared-Functions-Actions#actionmoveawayfromobject)
      - [`ActionMoveToLocation(lDestination, bRun)` - Routine 21](NSS-Shared-Functions-Actions#actionmovetolocation)
      - [`ActionMoveToObject(oMoveTo, bRun, fRange)` - Routine 22](NSS-Shared-Functions-Actions#actionmovetoobject)
      - [`ActionOpenDoor(oDoor)` - Routine 43](NSS-Shared-Functions-Actions#actionopendoor)
      - [`ActionPauseConversation()` - Routine 205](NSS-Shared-Functions-Actions#actionpauseconversation)
      - [`ActionPickUpItem(oItem)` - Routine 34](NSS-Shared-Functions-Actions#actionpickupitem)
      - [`ActionPlayAnimation(nAnimation, fSpeed, fDurationSeconds)` - Routine 40](NSS-Shared-Functions-Actions#actionplayanimation)
      - [`ActionPutDownItem(oItem)` - Routine 35](NSS-Shared-Functions-Actions#actionputdownitem)
      - [`ActionRandomWalk()` - Routine 20](NSS-Shared-Functions-Actions#actionrandomwalk)
      - [`ActionResumeConversation()` - Routine 206](NSS-Shared-Functions-Actions#actionresumeconversation)
      - [`ActionSpeakString(sStringToSpeak, nTalkVolume)` - Routine 39](NSS-Shared-Functions-Actions#actionspeakstring)
      - [`ActionSpeakStringByStrRef(nStrRef, nTalkVolume)` - Routine 240](NSS-Shared-Functions-Actions#actionspeakstringbystrref)
      - [`ActionStartConversation(oObjectToConverse, sDialogResRef, bPrivateConversation, nConversationType, bIgnoreStartRange, sNameObjectToIgnore1, sNameObjectToIgnore2, sNameObjectToIgnore3, sNameObjectToIgnore4, sNameObjectToIgnore5, sNameObjectToIgnore6, bUseLeader)` - Routine 204](NSS-Shared-Functions-Actions#actionstartconversation)
      - [`ActionSurrenderToEnemies()` - Routine 379](NSS-Shared-Functions-Actions#actionsurrendertoenemies)
      - [`ActionTakeItem(oItem, oTakeFrom)` - Routine 136](NSS-Shared-Functions-Actions#actiontakeitem)
      - [`ActionUnequipItem(oItem, bInstant)` - Routine 33](NSS-Shared-Functions-Actions#actionunequipitem)
      - [`ActionUnlockObject(oTarget)` - Routine 483](NSS-Shared-Functions-Actions#actionunlockobject)
      - [`ActionUseFeat(nFeat, oTarget)` - Routine 287](NSS-Shared-Functions-Actions#actionusefeat)
      - [`ActionUseSkill(nSkill, oTarget, nSubSkill, oItemUsed)` - Routine 288](NSS-Shared-Functions-Actions#actionuseskill)
      - [`ActionUseTalentAtLocation(tChosenTalent, lTargetLocation)` - Routine 310](NSS-Shared-Functions-Actions#actionusetalentatlocation)
      - [`ActionUseTalentOnObject(tChosenTalent, oTarget)` - Routine 309](NSS-Shared-Functions-Actions#actionusetalentonobject)
      - [`ActionWait(fSeconds)` - Routine 202](NSS-Shared-Functions-Actions#actionwait)
    - [Alignment System](#alignment-system)
      - [`AdjustAlignment(oSubject, nAlignment, nShift)` - Routine 201](NSS-Shared-Functions-Other-Functions#adjustalignment)
      - [`GetAlignmentGoodEvil(oCreature)` - Routine 127](NSS-Shared-Functions-Other-Functions#getalignmentgoodevil)
      - [`GetFactionAverageGoodEvilAlignment(oFactionMember)` - Routine 187](NSS-Shared-Functions-Other-Functions#getfactionaveragegoodevilalignment)
      - [`VersusAlignmentEffect(eEffect, nLawChaos, nGoodEvil)` - Routine 355](NSS-Shared-Functions-Other-Functions#versusalignmenteffect)
    - [Class System](#class-system)
      - [`AddMultiClass(nClassType, oSource)` - Routine 389](NSS-Shared-Functions-Other-Functions#addmulticlass)
      - [`GetClassByPosition(nClassPosition, oCreature)` - Routine 341](NSS-Shared-Functions-Other-Functions#getclassbyposition)
      - [`GetFactionMostFrequentClass(oFactionMember)` - Routine 191](NSS-Shared-Functions-Other-Functions#getfactionmostfrequentclass)
      - [`GetLevelByClass(nClassType, oCreature)` - Routine 343](NSS-Shared-Functions-Other-Functions#getlevelbyclass)
    - [Combat Functions](#combat-functions)
      - [`CancelCombat(oidCreature)` - Routine 54](NSS-Shared-Functions-Other-Functions#cancelcombat)
      - [`CutsceneAttack(oTarget, nAnimation, nAttackResult, nDamage)` - Routine 503](NSS-Shared-Functions-Other-Functions#cutsceneattack)
      - [`GetAttackTarget(oCreature)` - Routine 316](NSS-Shared-Functions-Other-Functions#getattacktarget)
      - [`GetAttemptedAttackTarget()` - Routine 361](NSS-Shared-Functions-Other-Functions#getattemptedattacktarget)
      - [`GetFirstAttacker(oCreature)` - Routine 727](NSS-Shared-Functions-Other-Functions#getfirstattacker)
      - [`GetGoingToBeAttackedBy(oTarget)` - Routine 211](NSS-Shared-Functions-Other-Functions#getgoingtobeattackedby)
      - [`GetIsInCombat(oCreature)` - Routine 320](NSS-Shared-Functions-Other-Functions#getisincombat)
      - [`GetLastAttackAction(oAttacker)` - Routine 722](NSS-Shared-Functions-Other-Functions#getlastattackaction)
      - [`GetLastAttacker(oAttackee)` - Routine 36](NSS-Shared-Functions-Other-Functions#getlastattacker)
      - [`GetLastAttackMode(oCreature)` - Routine 318](NSS-Shared-Functions-Other-Functions#getlastattackmode)
      - [`GetLastAttackResult(oAttacker)` - Routine 725](NSS-Shared-Functions-Other-Functions#getlastattackresult)
      - [`GetLastAttackType(oCreature)` - Routine 317](NSS-Shared-Functions-Other-Functions#getlastattacktype)
    ...
    - [Dialog and Conversation Functions](#dialog-and-conversation-functions)
      - [`BarkString(oCreature, strRef)` - Routine 671](NSS-Shared-Functions-Other-Functions#barkstring)
      - [`BeginConversation(sResRef, oObjectToDialog)` - Routine 255](NSS-Shared-Functions-Other-Functions#beginconversation)
      - [`CancelPostDialogCharacterSwitch()` - Routine 757](NSS-Shared-Functions-Other-Functions#cancelpostdialogcharacterswitch)
      - [`EventConversation()` - Routine 295](NSS-Shared-Functions-Other-Functions#eventconversation)
      - [`GetIsConversationActive()` - Routine 701](NSS-Shared-Functions-Other-Functions#getisconversationactive)
      - [`GetIsInConversation(oObject)` - Routine 445](NSS-Shared-Functions-Other-Functions#getisinconversation)
      - [`GetLastConversation()` - Routine 711](NSS-Shared-Functions-Other-Functions#getlastconversation)
      - [`GetLastSpeaker()` - Routine 254](NSS-Shared-Functions-Other-Functions#getlastspeaker)
      - [`HoldWorldFadeInForDialog()` - Routine 760](NSS-Shared-Functions-Other-Functions#holdworldfadeinfordialog)
      - [`ResetDialogState()` - Routine 749](NSS-Shared-Functions-Other-Functions#resetdialogstate)
      - [`SetDialogPlaceableCamera(nCameraId)` - Routine 461](NSS-Shared-Functions-Other-Functions#setdialogplaceablecamera)
      - [`SetLockHeadFollowInDialog(oObject, nValue)` - Routine 506](NSS-Shared-Functions-Other-Functions#setlockheadfollowindialog)
      - [`SetLockOrientationInDialog(oObject, nValue)` - Routine 505](NSS-Shared-Functions-Other-Functions#setlockorientationindialog)
      - [`SpeakOneLinerConversation(sDialogResRef, oTokenTarget)` - Routine 417](NSS-Shared-Functions-Other-Functions#speakonelinerconversation)
      - [`SpeakString(sStringToSpeak, nTalkVolume)` - Routine 221](NSS-Shared-Functions-Other-Functions#speakstring)
    - [Effects System](#effects-system)
      ...
      - [`EffectACIncrease(nValue, nModifyType, nDamageType)` - Routine 115](NSS-Shared-Functions-Effects-System#effectacincrease)
      - [`EffectAreaOfEffect(nAreaEffectId, sOnEnterScript, sHeartbeatScript, sOnExitScript)` - Routine 171](NSS-Shared-Functions-Effects-System#effectareaofeffect)
      - [`EffectAssuredDeflection(nReturn)` - Routine 252](NSS-Shared-Functions-Effects-System#effectassureddeflection)
      - [`EffectAssuredHit()` - Routine 51](NSS-Shared-Functions-Effects-System#effectassuredhit)
      - [`EffectAttackDecrease(nPenalty, nModifierType)` - Routine 447](NSS-Shared-Functions-Effects-System#effectattackdecrease)
      - [`EffectAttackIncrease(nBonus, nModifierType)` - Routine 118](NSS-Shared-Functions-Effects-System#effectattackincrease)
      - [`EffectBeam(nBeamVisualEffect, oEffector, nBodyPart, bMissEffect)` - Routine 207](NSS-Shared-Functions-Effects-System#effectbeam)
      - [`EffectBlasterDeflectionDecrease(nChange)` - Routine 470](NSS-Shared-Functions-Effects-System#effectblasterdeflectiondecrease)
      - [`EffectBlasterDeflectionIncrease(nChange)` - Routine 469](NSS-Shared-Functions-Effects-System#effectblasterdeflectionincrease)
      - [`EffectBodyFuel()` - Routine 224](NSS-Shared-Functions-Effects-System#effectbodyfuel)
      - [`EffectChoke()` - Routine 159](NSS-Shared-Functions-Effects-System#effectchoke)
      - [`EffectConcealment(nPercentage)` - Routine 458](NSS-Shared-Functions-Effects-System#effectconcealment)
      - [`EffectConfused()` - Routine 157](NSS-Shared-Functions-Effects-System#effectconfused)
      - [`EffectCutSceneHorrified()` - Routine 754](NSS-Shared-Functions-Effects-System#effectcutscenehorrified)
      - [`EffectCutSceneParalyze()` - Routine 755](NSS-Shared-Functions-Effects-System#effectcutsceneparalyze)
      - [`EffectCutSceneStunned()` - Routine 756](NSS-Shared-Functions-Effects-System#effectcutscenestunned)
      - [`EffectDamage(nDamageAmount, nDamageType, nDamagePower)` - Routine 79](NSS-Shared-Functions-Effects-System#effectdamage)
      - [`EffectDamageDecrease(nPenalty, nDamageType)` - Routine 448](NSS-Shared-Functions-Effects-System#effectdamagedecrease)
      - [`EffectDamageForcePoints(nDamage)` - Routine 372](NSS-Shared-Functions-Effects-System#effectdamageforcepoints)
      - [`EffectDamageImmunityDecrease(nDamageType, nPercentImmunity)` - Routine 449](NSS-Shared-Functions-Effects-System#effectdamageimmunitydecrease)
      - [`EffectDamageImmunityIncrease(nDamageType, nPercentImmunity)` - Routine 275](NSS-Shared-Functions-Effects-System#effectdamageimmunityincrease)
      - [`EffectDamageIncrease(nBonus, nDamageType)` - Routine 120](NSS-Shared-Functions-Effects-System#effectdamageincrease)
      - [`EffectDamageReduction(nAmount, nDamagePower, nLimit)` - Routine 119](NSS-Shared-Functions-Effects-System#effectdamagereduction)
      - [`EffectDamageResistance(nDamageType, nAmount, nLimit)` - Routine 81](NSS-Shared-Functions-Effects-System#effectdamageresistance)
      - [`EffectDamageShield(nDamageAmount, nRandomAmount, nDamageType)` - Routine 487](NSS-Shared-Functions-Effects-System#effectdamageshield)
      - [`EffectDeath(nSpectacularDeath, nDisplayFeedback)` - Routine 133](NSS-Shared-Functions-Effects-System#effectdeath)
      - [`EffectDisguise(nDisguiseAppearance)` - Routine 463](NSS-Shared-Functions-Effects-System#effectdisguise)
      - [`EffectDispelMagicAll(nCasterLevel)` - Routine 460](NSS-Shared-Functions-Effects-System#effectdispelmagicall)
      - [`EffectDispelMagicBest(nCasterLevel)` - Routine 473](NSS-Shared-Functions-Effects-System#effectdispelmagicbest)
      - [`EffectDroidStun()` - Routine 391](NSS-Shared-Functions-Effects-System#effectdroidstun)
      - [`EffectEntangle()` - Routine 130](NSS-Shared-Functions-Effects-System#effectentangle)
      - [`EffectForceDrain(nDamage)` - Routine 675](NSS-Shared-Functions-Effects-System#effectforcedrain)
      - [`EffectForceFizzle()` - Routine 420](NSS-Shared-Functions-Effects-System#effectforcefizzle)
      - [`EffectForceJump(oTarget, nAdvanced)` - Routine 153](NSS-Shared-Functions-Effects-System#effectforcejump)
      - [`EffectForcePushed()` - Routine 392](NSS-Shared-Functions-Effects-System#effectforcepushed)
      - [`EffectForcePushTargeted(lCentre, nIgnoreTestDirectLine)` - Routine 269](NSS-Shared-Functions-Effects-System#effectforcepushtargeted)
      - [`EffectForceResistanceDecrease(nValue)` - Routine 454](NSS-Shared-Functions-Effects-System#effectforceresistancedecrease)
      - [`EffectForceResistanceIncrease(nValue)` - Routine 212](NSS-Shared-Functions-Effects-System#effectforceresistanceincrease)
      - [`EffectForceResisted(oSource)` - Routine 402](NSS-Shared-Functions-Effects-System#effectforceresisted)
      - [`EffectForceShield(nShield)` - Routine 459](NSS-Shared-Functions-Effects-System#effectforceshield)
      - [`EffectFrightened()` - Routine 158](NSS-Shared-Functions-Effects-System#effectfrightened)
      - [`EffectHaste()` - Routine 270](NSS-Shared-Functions-Effects-System#effecthaste)
      - [`EffectHeal(nDamageToHeal)` - Routine 78](NSS-Shared-Functions-Effects-System#effectheal)
      - [`EffectHealForcePoints(nHeal)` - Routine 373](NSS-Shared-Functions-Effects-System#effecthealforcepoints)
      - [`EffectHitPointChangeWhenDying(fHitPointChangePerRound)` - Routine 387](NSS-Shared-Functions-Effects-System#effecthitpointchangewhendying)
      - [`EffectHorrified()` - Routine 471](NSS-Shared-Functions-Effects-System#effecthorrified)
      - [`EffectImmunity(nImmunityType)` - Routine 273](NSS-Shared-Functions-Effects-System#effectimmunity)
      - [`EffectInvisibility(nInvisibilityType)` - Routine 457](NSS-Shared-Functions-Effects-System#effectinvisibility)
      - [`EffectKnockdown()` - Routine 134](NSS-Shared-Functions-Effects-System#effectknockdown)
      - [`EffectLightsaberThrow(oTarget1, oTarget2, oTarget3, nAdvancedDamage)` - Routine 702](NSS-Shared-Functions-Effects-System#effectlightsaberthrow)
      - [`EffectLinkEffects(eChildEffect, eParentEffect)` - Routine 199](NSS-Shared-Functions-Effects-System#effectlinkeffects)
      - [`EffectMissChance(nPercentage)` - Routine 477](NSS-Shared-Functions-Effects-System#effectmisschance)
      - [`EffectModifyAttacks(nAttacks)` - Routine 485](NSS-Shared-Functions-Effects-System#effectmodifyattacks)
      - [`EffectMovementSpeedDecrease(nPercentChange)` - Routine 451](NSS-Shared-Functions-Effects-System#effectmovementspeeddecrease)
      - [`EffectMovementSpeedIncrease(nNewSpeedPercent)` - Routine 165](NSS-Shared-Functions-Effects-System#effectmovementspeedincrease)
      - [`EffectParalyze()` - Routine 148](NSS-Shared-Functions-Effects-System#effectparalyze)
      - [`EffectPoison(nPoisonType)` - Routine 250](NSS-Shared-Functions-Effects-System#effectpoison)
      - [`EffectPsychicStatic()` - Routine 676](NSS-Shared-Functions-Effects-System#effectpsychicstatic)
      - [`EffectRegenerate(nAmount, fIntervalSeconds)` - Routine 164](NSS-Shared-Functions-Effects-System#effectregenerate)
      - [`EffectResurrection()` - Routine 82](NSS-Shared-Functions-Effects-System#effectresurrection)
      - [`EffectSavingThrowDecrease(nSave, nValue, nSaveType)` - Routine 452](NSS-Shared-Functions-Effects-System#effectsavingthrowdecrease)
      - [`EffectSavingThrowIncrease(nSave, nValue, nSaveType)` - Routine 117](NSS-Shared-Functions-Effects-System#effectsavingthrowincrease)
      - [`EffectSeeInvisible()` - Routine 466](NSS-Shared-Functions-Effects-System#effectseeinvisible)
      - [`EffectSkillDecrease(nSkill, nValue)` - Routine 453](NSS-Shared-Functions-Effects-System#effectskilldecrease)
      - [`EffectSkillIncrease(nSkill, nValue)` - Routine 351](NSS-Shared-Functions-Effects-System#effectskillincrease)
      - [`EffectSleep()` - Routine 154](NSS-Shared-Functions-Effects-System#effectsleep)
      - [`EffectSpellImmunity(nImmunityToSpell)` - Routine 149](NSS-Shared-Functions-Effects-System#effectspellimmunity)
      - [`EffectSpellLevelAbsorption(nMaxSpellLevelAbsorbed, nTotalSpellLevelsAbsorbed, nSpellSchool)` - Routine 472](NSS-Shared-Functions-Effects-System#effectspelllevelabsorption)
      - [`EffectStunned()` - Routine 161](NSS-Shared-Functions-Effects-System#effectstunned)
      - [`EffectTemporaryForcePoints(nTempForce)` - Routine 156](NSS-Shared-Functions-Effects-System#effecttemporaryforcepoints)
      - [`EffectTemporaryHitpoints(nHitPoints)` - Routine 314](NSS-Shared-Functions-Effects-System#effecttemporaryhitpoints)
      - [`EffectTimeStop()` - Routine 467](NSS-Shared-Functions-Effects-System#effecttimestop)
      ...
      - [`GetAreaOfEffectCreator(oAreaOfEffectObject)` - Routine 264](NSS-Shared-Functions-Other-Functions#getareaofeffectcreator)
      ...
      - [`SWMG_SetSpeedBlurEffect(bEnabled, fRatio)` - Routine 563](NSS-Shared-Functions-Other-Functions#swmgsetspeedblureffect)
    ...
    - [Global Variables](#global-variables)
      ...
      - [`GetGlobalNumber(sIdentifier)` - Routine 580](NSS-Shared-Functions-Global-Variables#getglobalnumber)
      - [`GetGlobalString(sIdentifier)` - Routine 194](NSS-Shared-Functions-Global-Variables#getglobalstring)
      - [`SetGlobalBoolean(sIdentifier, nValue)` - Routine 579](NSS-Shared-Functions-Global-Variables#setglobalboolean)
      - [`SetGlobalFadeIn(fWait, fLength, fR, fG, fB)` - Routine 719](NSS-Shared-Functions-Global-Variables#setglobalfadein)
      - [`SetGlobalFadeOut(fWait, fLength, fR, fG, fB)` - Routine 720](NSS-Shared-Functions-Global-Variables#setglobalfadeout)
      - [`SetGlobalLocation(sIdentifier, lValue)` - Routine 693](NSS-Shared-Functions-Global-Variables#setgloballocation)
    ...
    - [Item Management](#item-management)
      ...
      - [`GetItemActivator()` - Routine 440](NSS-Shared-Functions-Item-Management#getitemactivator)
      - [`GetItemACValue(oItem)` - Routine 401](NSS-Shared-Functions-Item-Management#getitemacvalue)
      - [`GetItemInSlot(nInventorySlot, oCreature)` - Routine 155](NSS-Shared-Functions-Item-Management#getiteminslot)
      ...
      - [`GetModuleItemAcquired()` - Routine 282](NSS-Shared-Functions-Other-Functions#getmoduleitemacquired)
      - [`GetModuleItemAcquiredFrom()` - Routine 283](NSS-Shared-Functions-Other-Functions#getmoduleitemacquiredfrom)
      - [`GetModuleItemLost()` - Routine 292](NSS-Shared-Functions-Other-Functions#getmoduleitemlost)
      - [`GetModuleItemLostBy()` - Routine 293](NSS-Shared-Functions-Other-Functions#getmoduleitemlostby)
    ...
    - [Module and Area Functions](#module-and-area-functions)
      - [`GetArea(oTarget)` - Routine 24](NSS-Shared-Functions-Other-Functions#getarea)
      - [`GetAreaUnescapable()` - Routine 15](NSS-Shared-Functions-Other-Functions#getareaunescapable)
      - [`GetFirstObjectInArea(oArea, nObjectFilter)` - Routine 93](NSS-Shared-Functions-Other-Functions#getfirstobjectinarea)
      - [`GetModule()` - Routine 242](NSS-Shared-Functions-Other-Functions#getmodule)
      - [`GetModuleFileName()` - Routine 210](NSS-Shared-Functions-Other-Functions#getmodulefilename)
      - [`GetModuleName()` - Routine 561](NSS-Shared-Functions-Other-Functions#getmodulename)
    ...
    - [Object Query and Manipulation](#object-query-and-manipulation)
      ...
      - [`GetObjectByTag(sTag, nNth)` - Routine 200](NSS-Shared-Functions-Other-Functions#getobjectbytag)
      - [`GetObjectHeard(oTarget, oSource)` - Routine 290](NSS-Shared-Functions-Other-Functions#getobjectheard)
      - [`GetObjectSeen(oTarget, oSource)` - Routine 289](NSS-Shared-Functions-Other-Functions#getobjectseen)
      - [`GetObjectType(oTarget)` - Routine 106](NSS-Shared-Functions-Other-Functions#getobjecttype)
      - [`GetSpellTargetObject()` - Routine 47](NSS-Shared-Functions-Other-Functions#getspelltargetobject)
      - [`SWMG_GetObjectByName(sName)` - Routine 585](NSS-Shared-Functions-Other-Functions#swmggetobjectbyname)
      - [`SWMG_GetObjectName(oid)` - Routine 597](NSS-Shared-Functions-Other-Functions#swmggetobjectname)
    - [Other Functions](#other-functions)
      ...
      - [`GetAttemptedSpellTarget()` - Routine 375](NSS-Shared-Functions-Other-Functions#getattemptedspelltarget)
      - [`GetBlockingCreature(oTarget)` - Routine 490](NSS-Shared-Functions-Other-Functions#getblockingcreature)
      - [`GetBlockingDoor()` - Routine 336](NSS-Shared-Functions-Other-Functions#getblockingdoor)
      - [`GetButtonMashCheck()` - Routine 267](NSS-Shared-Functions-Other-Functions#getbuttonmashcheck)
      - [`GetCasterLevel(oCreature)` - Routine 84](NSS-Shared-Functions-Other-Functions#getcasterlevel)
      - [`GetCategoryFromTalent(tTalent)` - Routine 735](NSS-Shared-Functions-Other-Functions#getcategoryfromtalent)
      - [`GetChallengeRating(oCreature)` - Routine 494](NSS-Shared-Functions-Other-Functions#getchallengerating)
      - [`GetCheatCode(nCode)` - Routine 764](NSS-Shared-Functions-Other-Functions#getcheatcode)
      - [`GetClickingObject()` - Routine 326](NSS-Shared-Functions-Other-Functions#getclickingobject)
      - [`GetCommandable(oTarget)` - Routine 163](NSS-Shared-Functions-Other-Functions#getcommandable)
      - [`GetCreatureHasTalent(tTalent, oCreature)` - Routine 306](NSS-Shared-Functions-Other-Functions#getcreaturehastalent)
      - [`GetCreatureMovmentType(oidCreature)` - Routine 566](NSS-Shared-Functions-Other-Functions#getcreaturemovmenttype)
      - [`GetCreatureSize(oCreature)` - Routine 479](NSS-Shared-Functions-Other-Functions#getcreaturesize)
      - [`GetCreatureTalentBest(nCategory, nCRMax, oCreature, nInclusion, nExcludeType, nExcludeId)` - Routine 308](NSS-Shared-Functions-Other-Functions#getcreaturetalentbest)
      - [`GetCreatureTalentRandom(nCategory, oCreature, nInclusion)` - Routine 307](NSS-Shared-Functions-Other-Functions#getcreaturetalentrandom)
      - [`GetCurrentAction(oObject)` - Routine 522](NSS-Shared-Functions-Other-Functions#getcurrentaction)
      - [`GetCurrentForcePoints(oObject)` - Routine 55](NSS-Shared-Functions-Other-Functions#getcurrentforcepoints)
      - [`GetCurrentHitPoints(oObject)` - Routine 49](NSS-Shared-Functions-Other-Functions#getcurrenthitpoints)
      - [`GetCurrentStealthXP()` - Routine 474](NSS-Shared-Functions-Other-Functions#getcurrentstealthxp)
      - [`GetDamageDealtByType(nDamageType)` - Routine 344](NSS-Shared-Functions-Other-Functions#getdamagedealtbytype)
      - [`GetDifficultyModifier()` - Routine 523](NSS-Shared-Functions-Other-Functions#getdifficultymodifier)
      - [`GetDistanceBetween(oObjectA, oObjectB)` - Routine 151](NSS-Shared-Functions-Other-Functions#getdistancebetween)
      - [`GetDistanceBetween2D(oObjectA, oObjectB)` - Routine 319](NSS-Shared-Functions-Other-Functions#getdistancebetween2d)
      - [`GetDistanceBetweenLocations(lLocationA, lLocationB)` - Routine 298](NSS-Shared-Functions-Other-Functions#getdistancebetweenlocations)
      - [`GetDistanceBetweenLocations2D(lLocationA, lLocationB)` - Routine 334](NSS-Shared-Functions-Other-Functions#getdistancebetweenlocations2d)
      - [`GetDistanceToObject(oObject)` - Routine 41](NSS-Shared-Functions-Other-Functions#getdistancetoobject)
      - [`GetDistanceToObject2D(oObject)` - Routine 335](NSS-Shared-Functions-Other-Functions#getdistancetoobject2d)
      - [`GetEncounterActive(oEncounter)` - Routine 276](NSS-Shared-Functions-Other-Functions#getencounteractive)
      - [`GetEncounterDifficulty(oEncounter)` - Routine 297](NSS-Shared-Functions-Other-Functions#getencounterdifficulty)
      - [`GetEncounterSpawnsCurrent(oEncounter)` - Routine 280](NSS-Shared-Functions-Other-Functions#getencounterspawnscurrent)
      - [`GetEncounterSpawnsMax(oEncounter)` - Routine 278](NSS-Shared-Functions-Other-Functions#getencounterspawnsmax)
      - [`GetEnteringObject()` - Routine 25](NSS-Shared-Functions-Other-Functions#getenteringobject)
      - [`GetExitingObject()` - Routine 26](NSS-Shared-Functions-Other-Functions#getexitingobject)
      - [`GetFacing(oTarget)` - Routine 28](NSS-Shared-Functions-Other-Functions#getfacing)
      - [`GetFacingFromLocation(lLocation)` - Routine 225](NSS-Shared-Functions-Other-Functions#getfacingfromlocation)
      - [`GetFactionAverageLevel(oFactionMember)` - Routine 189](NSS-Shared-Functions-Other-Functions#getfactionaveragelevel)
      - [`GetFactionAverageReputation(oSourceFactionMember, oTarget)` - Routine 186](NSS-Shared-Functions-Other-Functions#getfactionaveragereputation)
      - [`GetFactionAverageXP(oFactionMember)` - Routine 190](NSS-Shared-Functions-Other-Functions#getfactionaveragexp)
      - [`GetFactionBestAC(oFactionMember, bMustBeVisible)` - Routine 193](NSS-Shared-Functions-Other-Functions#getfactionbestac)
      - [`GetFactionEqual(oFirstObject, oSecondObject)` - Routine 172](NSS-Shared-Functions-Other-Functions#getfactionequal)
      - [`GetFactionGold(oFactionMember)` - Routine 185](NSS-Shared-Functions-Other-Functions#getfactiongold)
      - [`GetFactionLeader(oMemberOfFaction)` - Routine 562](NSS-Shared-Functions-Other-Functions#getfactionleader)
      - [`GetFactionLeastDamagedMember(oFactionMember, bMustBeVisible)` - Routine 184](NSS-Shared-Functions-Other-Functions#getfactionleastdamagedmember)
      - [`GetFactionMostDamagedMember(oFactionMember, bMustBeVisible)` - Routine 183](NSS-Shared-Functions-Other-Functions#getfactionmostdamagedmember)
      - [`GetFactionStrongestMember(oFactionMember, bMustBeVisible)` - Routine 182](NSS-Shared-Functions-Other-Functions#getfactionstrongestmember)
      - [`GetFactionWeakestMember(oFactionMember, bMustBeVisible)` - Routine 181](NSS-Shared-Functions-Other-Functions#getfactionweakestmember)
      - [`GetFactionWorstAC(oFactionMember, bMustBeVisible)` - Routine 192](NSS-Shared-Functions-Other-Functions#getfactionworstac)
      - [`GetFirstFactionMember(oMemberOfFaction, bPCOnly)` - Routine 380](NSS-Shared-Functions-Other-Functions#getfirstfactionmember)
      ...
      - [`GetFirstObjectInShape(nShape, fSize, lTarget, bLineOfSight, nObjectFilter, vOrigin)` - Routine 128](NSS-Shared-Functions-Other-Functions#getfirstobjectinshape)
      - [`GetFirstPC()` - Routine 548](NSS-Shared-Functions-Other-Functions#getfirstpc)
      - [`GetFortitudeSavingThrow(oTarget)` - Routine 491](NSS-Shared-Functions-Other-Functions#getfortitudesavingthrow)
      - [`GetFoundEnemyCreature(oTarget)` - Routine 495](NSS-Shared-Functions-Other-Functions#getfoundenemycreature)
      - [`GetGameDifficulty()` - Routine 513](NSS-Shared-Functions-Other-Functions#getgamedifficulty)
      - [`GetGender(oCreature)` - Routine 358](NSS-Shared-Functions-Other-Functions#getgender)
      - [`GetGold(oTarget)` - Routine 418](NSS-Shared-Functions-Other-Functions#getgold)
      - [`GetGoldPieceValue(oItem)` - Routine 311](NSS-Shared-Functions-Other-Functions#getgoldpiecevalue)
      - [`GetGoodEvilValue(oCreature)` - Routine 125](NSS-Shared-Functions-Other-Functions#getgoodevilvalue)
      - [`GetHasInventory(oObject)` - Routine 570](NSS-Shared-Functions-Other-Functions#gethasinventory)
      - [`GetHasSpell(nSpell, oCreature)` - Routine 377](NSS-Shared-Functions-Other-Functions#gethasspell)
      - [`GetHitDice(oCreature)` - Routine 166](NSS-Shared-Functions-Other-Functions#gethitdice)
      - [`GetIdentified(oItem)` - Routine 332](NSS-Shared-Functions-Other-Functions#getidentified)
      - [`GetIdFromTalent(tTalent)` - Routine 363](NSS-Shared-Functions-Other-Functions#getidfromtalent)
      - [`GetInventoryDisturbType()` - Routine 352](NSS-Shared-Functions-Other-Functions#getinventorydisturbtype)
      - [`GetIsDawn()` - Routine 407](NSS-Shared-Functions-Other-Functions#getisdawn)
      - [`GetIsDay()` - Routine 405](NSS-Shared-Functions-Other-Functions#getisday)
      - [`GetIsDead(oCreature)` - Routine 140](NSS-Shared-Functions-Other-Functions#getisdead)
      - [`GetIsDebilitated(oCreature)` - Routine 732](NSS-Shared-Functions-Other-Functions#getisdebilitated)
      - [`GetIsDoorActionPossible(oTargetDoor, nDoorAction)` - Routine 337](NSS-Shared-Functions-Other-Functions#getisdooractionpossible)
      - [`GetIsDusk()` - Routine 408](NSS-Shared-Functions-Other-Functions#getisdusk)
      - [`GetIsEncounterCreature(oCreature)` - Routine 409](NSS-Shared-Functions-Other-Functions#getisencountercreature)
      - [`GetIsEnemy(oTarget, oSource)` - Routine 235](NSS-Shared-Functions-Other-Functions#getisenemy)
      - [`GetIsFriend(oTarget, oSource)` - Routine 236](NSS-Shared-Functions-Other-Functions#getisfriend)
      - [`GetIsImmune(oCreature, nImmunityType, oVersus)` - Routine 274](NSS-Shared-Functions-Other-Functions#getisimmune)
      - [`GetIsLinkImmune(oTarget, eEffect)` - Routine 390](NSS-Shared-Functions-Other-Functions#getislinkimmune)
      - [`GetIsListening(oObject)` - Routine 174](NSS-Shared-Functions-Other-Functions#getislistening)
      - [`GetIsLiveContentAvailable(nPkg)` - Routine 748](NSS-Shared-Functions-Other-Functions#getislivecontentavailable)
      - [`GetIsNeutral(oTarget, oSource)` - Routine 237](NSS-Shared-Functions-Other-Functions#getisneutral)
      - [`GetIsNight()` - Routine 406](NSS-Shared-Functions-Other-Functions#getisnight)
      - [`GetIsObjectValid(oObject)` - Routine 42](NSS-Shared-Functions-Other-Functions#getisobjectvalid)
      - [`GetIsOpen(oObject)` - Routine 443](NSS-Shared-Functions-Other-Functions#getisopen)
      - [`GetIsPlaceableObjectActionPossible(oPlaceable, nPlaceableAction)` - Routine 546](NSS-Shared-Functions-Other-Functions#getisplaceableobjectactionpossible)
      - [`GetIsPoisoned(oObject)` - Routine 751](NSS-Shared-Functions-Other-Functions#getispoisoned)
      - [`GetIsTalentValid(tTalent)` - Routine 359](NSS-Shared-Functions-Other-Functions#getistalentvalid)
      - [`GetIsTrapped(oObject)` - Routine 551](NSS-Shared-Functions-Other-Functions#getistrapped)
      - [`GetJournalEntry(szPlotID)` - Routine 369](NSS-Shared-Functions-Other-Functions#getjournalentry)
      ...
      - [`GetLastHostileActor(oVictim)` - Routine 556](NSS-Shared-Functions-Other-Functions#getlasthostileactor)
      - [`GetLastHostileTarget(oAttacker)` - Routine 721](NSS-Shared-Functions-Other-Functions#getlasthostiletarget)
      - [`GetLastLocked()` - Routine 349](NSS-Shared-Functions-Other-Functions#getlastlocked)
      - [`GetLastOpenedBy()` - Routine 376](NSS-Shared-Functions-Other-Functions#getlastopenedby)
      - [`GetLastPazaakResult()` - Routine 365](NSS-Shared-Functions-Other-Functions#getlastpazaakresult)
      - [`GetLastPerceived()` - Routine 256](NSS-Shared-Functions-Other-Functions#getlastperceived)
      - [`GetLastPerceptionHeard()` - Routine 257](NSS-Shared-Functions-Other-Functions#getlastperceptionheard)
      - [`GetLastPerceptionInaudible()` - Routine 258](NSS-Shared-Functions-Other-Functions#getlastperceptioninaudible)
      - [`GetLastPerceptionSeen()` - Routine 259](NSS-Shared-Functions-Other-Functions#getlastperceptionseen)
      - [`GetLastPerceptionVanished()` - Routine 261](NSS-Shared-Functions-Other-Functions#getlastperceptionvanished)
      - [`GetLastRespawnButtonPresser()` - Routine 419](NSS-Shared-Functions-Other-Functions#getlastrespawnbuttonpresser)
      - [`GetLastSpell()` - Routine 246](NSS-Shared-Functions-Other-Functions#getlastspell)
      - [`GetLastSpellCaster()` - Routine 245](NSS-Shared-Functions-Other-Functions#getlastspellcaster)
      - [`GetLastSpellHarmful()` - Routine 423](NSS-Shared-Functions-Other-Functions#getlastspellharmful)
      - [`GetLastTrapDetected(oTarget)` - Routine 486](NSS-Shared-Functions-Other-Functions#getlasttrapdetected)
      - [`GetLastUnlocked()` - Routine 350](NSS-Shared-Functions-Other-Functions#getlastunlocked)
      - [`GetLastUsedBy()` - Routine 330](NSS-Shared-Functions-Other-Functions#getlastusedby)
      - [`GetLastWeaponUsed(oCreature)` - Routine 328](NSS-Shared-Functions-Other-Functions#getlastweaponused)
      - [`GetLevelByPosition(nClassPosition, oCreature)` - Routine 342](NSS-Shared-Functions-Other-Functions#getlevelbyposition)
      - [`GetListenPatternNumber()` - Routine 195](NSS-Shared-Functions-Other-Functions#getlistenpatternnumber)
      - [`GetLoadFromSaveGame()` - Routine 251](NSS-Shared-Functions-Other-Functions#getloadfromsavegame)
      - [`GetLocation(oObject)` - Routine 213](NSS-Shared-Functions-Other-Functions#getlocation)
      - [`GetLocked(oTarget)` - Routine 325](NSS-Shared-Functions-Other-Functions#getlocked)
      - [`GetLockKeyRequired(oObject)` - Routine 537](NSS-Shared-Functions-Other-Functions#getlockkeyrequired)
      - [`GetLockKeyTag(oObject)` - Routine 538](NSS-Shared-Functions-Other-Functions#getlockkeytag)
      - [`GetLockLockable(oObject)` - Routine 539](NSS-Shared-Functions-Other-Functions#getlocklockable)
      - [`GetLockLockDC(oObject)` - Routine 541](NSS-Shared-Functions-Other-Functions#getlocklockdc)
      - [`GetLockUnlockDC(oObject)` - Routine 540](NSS-Shared-Functions-Other-Functions#getlockunlockdc)
      - [`GetMatchedSubstring(nString)` - Routine 178](NSS-Shared-Functions-Other-Functions#getmatchedsubstring)
      - [`GetMatchedSubstringsCount()` - Routine 179](NSS-Shared-Functions-Other-Functions#getmatchedsubstringscount)
      - [`GetMaxForcePoints(oObject)` - Routine 56](NSS-Shared-Functions-Other-Functions#getmaxforcepoints)
      - [`GetMaxHitPoints(oObject)` - Routine 50](NSS-Shared-Functions-Other-Functions#getmaxhitpoints)
      - [`GetMaxStealthXP()` - Routine 464](NSS-Shared-Functions-Other-Functions#getmaxstealthxp)
      - [`GetMinOneHP(oObject)` - Routine 715](NSS-Shared-Functions-Other-Functions#getminonehp)
      - [`GetMovementRate(oCreature)` - Routine 496](NSS-Shared-Functions-Other-Functions#getmovementrate)
      - [`GetName(oObject)` - Routine 253](NSS-Shared-Functions-Other-Functions#getname)
      - [`GetNextFactionMember(oMemberOfFaction, bPCOnly)` - Routine 381](NSS-Shared-Functions-Other-Functions#getnextfactionmember)
      ...
      - [`GetPlotFlag(oTarget)` - Routine 455](NSS-Shared-Functions-Other-Functions#getplotflag)
      - [`GetPosition(oTarget)` - Routine 27](NSS-Shared-Functions-Other-Functions#getposition)
      - [`GetPositionFromLocation(lLocation)` - Routine 223](NSS-Shared-Functions-Other-Functions#getpositionfromlocation)
      - [`GetRacialType(oCreature)` - Routine 107](NSS-Shared-Functions-Other-Functions#getracialtype)
      - [`GetReflexAdjustedDamage(nDamage, oTarget, nDC, nSaveType, oSaveVersus)` - Routine 299](NSS-Shared-Functions-Other-Functions#getreflexadjusteddamage)
      - [`GetReflexSavingThrow(oTarget)` - Routine 493](NSS-Shared-Functions-Other-Functions#getreflexsavingthrow)
      - [`GetReputation(oSource, oTarget)` - Routine 208](NSS-Shared-Functions-Other-Functions#getreputation)
      - [`GetRunScriptVar()` - Routine 565](NSS-Shared-Functions-Other-Functions#getrunscriptvar)
      - [`GetSelectedPlanet()` - Routine 744](NSS-Shared-Functions-Other-Functions#getselectedplanet)
      - [`GetSoloMode()` - Routine 462](NSS-Shared-Functions-Other-Functions#getsolomode)
      - [`GetSpellId()` - Routine 248](NSS-Shared-Functions-Other-Functions#getspellid)
      - [`GetSpellSaveDC()` - Routine 111](NSS-Shared-Functions-Other-Functions#getspellsavedc)
      - [`GetSpellTarget(oCreature)` - Routine 752](NSS-Shared-Functions-Other-Functions#getspelltarget)
      - [`GetSpellTargetLocation()` - Routine 222](NSS-Shared-Functions-Other-Functions#getspelltargetlocation)
      - [`GetStandardFaction(oObject)` - Routine 713](NSS-Shared-Functions-Other-Functions#getstandardfaction)
      - [`GetStartingLocation()` - Routine 411](NSS-Shared-Functions-Other-Functions#getstartinglocation)
      - [`GetStealthXPDecrement()` - Routine 498](NSS-Shared-Functions-Other-Functions#getstealthxpdecrement)
      - [`GetStealthXPEnabled()` - Routine 481](NSS-Shared-Functions-Other-Functions#getstealthxpenabled)
      - [`GetStringByStrRef(nStrRef)` - Routine 239](NSS-Shared-Functions-Other-Functions#getstringbystrref)
      - [`GetStringLeft(sString, nCount)` - Routine 63](NSS-Shared-Functions-Other-Functions#getstringleft)
      - [`GetStringLength(sString)` - Routine 59](NSS-Shared-Functions-Other-Functions#getstringlength)
      - [`GetStringLowerCase(sString)` - Routine 61](NSS-Shared-Functions-Other-Functions#getstringlowercase)
      - [`GetStringRight(sString, nCount)` - Routine 62](NSS-Shared-Functions-Other-Functions#getstringright)
      - [`GetStringUpperCase(sString)` - Routine 60](NSS-Shared-Functions-Other-Functions#getstringuppercase)
      - [`GetSubRace(oCreature)` - Routine 497](NSS-Shared-Functions-Other-Functions#getsubrace)
      - [`GetSubScreenID()` - Routine 53](NSS-Shared-Functions-Other-Functions#getsubscreenid)
      - [`GetSubString(sString, nStart, nCount)` - Routine 65](NSS-Shared-Functions-Other-Functions#getsubstring)
      - [`GetTag(oObject)` - Routine 168](NSS-Shared-Functions-Other-Functions#gettag)
      - [`GetTimeHour()` - Routine 16](NSS-Shared-Functions-Other-Functions#gettimehour)
      - [`GetTimeMillisecond()` - Routine 19](NSS-Shared-Functions-Other-Functions#gettimemillisecond)
      - [`GetTimeMinute()` - Routine 17](NSS-Shared-Functions-Other-Functions#gettimeminute)
      - [`GetTimeSecond()` - Routine 18](NSS-Shared-Functions-Other-Functions#gettimesecond)
      - [`GetTotalDamageDealt()` - Routine 345](NSS-Shared-Functions-Other-Functions#gettotaldamagedealt)
      - [`GetTransitionTarget(oTransition)` - Routine 198](NSS-Shared-Functions-Other-Functions#gettransitiontarget)
      - [`GetTrapBaseType(oTrapObject)` - Routine 531](NSS-Shared-Functions-Other-Functions#gettrapbasetype)
      - [`GetTrapCreator(oTrapObject)` - Routine 533](NSS-Shared-Functions-Other-Functions#gettrapcreator)
      - [`GetTrapDetectable(oTrapObject)` - Routine 528](NSS-Shared-Functions-Other-Functions#gettrapdetectable)
      - [`GetTrapDetectDC(oTrapObject)` - Routine 536](NSS-Shared-Functions-Other-Functions#gettrapdetectdc)
      - [`GetTrapDetectedBy(oTrapObject, oCreature)` - Routine 529](NSS-Shared-Functions-Other-Functions#gettrapdetectedby)
      - [`GetTrapDisarmable(oTrapObject)` - Routine 527](NSS-Shared-Functions-Other-Functions#gettrapdisarmable)
      - [`GetTrapDisarmDC(oTrapObject)` - Routine 535](NSS-Shared-Functions-Other-Functions#gettrapdisarmdc)
      - [`GetTrapFlagged(oTrapObject)` - Routine 530](NSS-Shared-Functions-Other-Functions#gettrapflagged)
      - [`GetTrapKeyTag(oTrapObject)` - Routine 534](NSS-Shared-Functions-Other-Functions#gettrapkeytag)
      - [`GetTrapOneShot(oTrapObject)` - Routine 532](NSS-Shared-Functions-Other-Functions#gettraponeshot)
      - [`GetTypeFromTalent(tTalent)` - Routine 362](NSS-Shared-Functions-Other-Functions#gettypefromtalent)
      - [`GetUserActionsPending()` - Routine 514](NSS-Shared-Functions-Other-Functions#getuseractionspending)
      - [`GetUserDefinedEventNumber()` - Routine 247](NSS-Shared-Functions-Other-Functions#getuserdefinedeventnumber)
      - [`GetWasForcePowerSuccessful(oAttacker)` - Routine 726](NSS-Shared-Functions-Other-Functions#getwasforcepowersuccessful)
      - [`GetWaypointByTag(sWaypointTag)` - Routine 197](NSS-Shared-Functions-Other-Functions#getwaypointbytag)
      ...
      - [`SetCameraFacing(fDirection)` - Routine 45](NSS-Shared-Functions-Other-Functions#setcamerafacing)
      - [`SetCameraMode(oPlayer, nCameraMode)` - Routine 504](NSS-Shared-Functions-Other-Functions#setcameramode)
      - [`SetCommandable(bCommandable, oTarget)` - Routine 162](NSS-Shared-Functions-Other-Functions#setcommandable)
      - [`SetCurrentStealthXP(nCurrent)` - Routine 478](NSS-Shared-Functions-Other-Functions#setcurrentstealthxp)
      - [`SetCustomToken(nCustomTokenNumber, sTokenValue)` - Routine 284](NSS-Shared-Functions-Other-Functions#setcustomtoken)
      - [`SetEncounterActive(nNewValue, oEncounter)` - Routine 277](NSS-Shared-Functions-Other-Functions#setencounteractive)
      - [`SetEncounterDifficulty(nEncounterDifficulty, oEncounter)` - Routine 296](NSS-Shared-Functions-Other-Functions#setencounterdifficulty)
      - [`SetEncounterSpawnsCurrent(nNewValue, oEncounter)` - Routine 281](NSS-Shared-Functions-Other-Functions#setencounterspawnscurrent)
      - [`SetEncounterSpawnsMax(nNewValue, oEncounter)` - Routine 279](NSS-Shared-Functions-Other-Functions#setencounterspawnsmax)
      - [`SetFacing(fDirection)` - Routine 10](NSS-Shared-Functions-Other-Functions#setfacing)
      - [`SetFacingPoint(vTarget)` - Routine 143](NSS-Shared-Functions-Other-Functions#setfacingpoint)
      - [`SetForcePowerUnsuccessful(nResult, oCreature)` - Routine 731](NSS-Shared-Functions-Other-Functions#setforcepowerunsuccessful)
      - [`SetFormation(oAnchor, oCreature, nFormationPattern, nPosition)` - Routine 729](NSS-Shared-Functions-Other-Functions#setformation)
      - [`SetGoodEvilValue(oCreature, nAlignment)` - Routine 750](NSS-Shared-Functions-Other-Functions#setgoodevilvalue)
      - [`SetIdentified(oItem, bIdentified)` - Routine 333](NSS-Shared-Functions-Other-Functions#setidentified)
      - [`SetIsDestroyable(bDestroyable, bRaiseable, bSelectableWhenDead)` - Routine 323](NSS-Shared-Functions-Other-Functions#setisdestroyable)
      - [`SetJournalQuestEntryPicture(szPlotID, oObject, nPictureIndex, bAllPartyMemebers, bAllPlayers)` - Routine 678](NSS-Shared-Functions-Other-Functions#setjournalquestentrypicture)
      - [`SetLightsaberPowered(oCreature, bOverride, bPowered, bShowTransition)` - Routine 421](NSS-Shared-Functions-Other-Functions#setlightsaberpowered)
      - [`SetListening(oObject, bValue)` - Routine 175](NSS-Shared-Functions-Other-Functions#setlistening)
      - [`SetListenPattern(oObject, sPattern, nNumber)` - Routine 176](NSS-Shared-Functions-Other-Functions#setlistenpattern)
      - [`SetLocked(oTarget, bLocked)` - Routine 324](NSS-Shared-Functions-Other-Functions#setlocked)
      - [`SetMapPinEnabled(oMapPin, nEnabled)` - Routine 386](NSS-Shared-Functions-Other-Functions#setmappinenabled)
      ...
      - [`SetPlotFlag(oTarget, nPlotFlag)` - Routine 456](NSS-Shared-Functions-Other-Functions#setplotflag)
      - [`SetReturnStrref(bShow, srStringRef, srReturnQueryStrRef)` - Routine 152](NSS-Shared-Functions-Other-Functions#setreturnstrref)
      - [`SetSoloMode(bActivate)` - Routine 753](NSS-Shared-Functions-Other-Functions#setsolomode)
      - [`SetStealthXPDecrement(nDecrement)` - Routine 499](NSS-Shared-Functions-Other-Functions#setstealthxpdecrement)
      - [`SetStealthXPEnabled(bEnabled)` - Routine 482](NSS-Shared-Functions-Other-Functions#setstealthxpenabled)
      - [`SetTime(nHour, nMinute, nSecond, nMillisecond)` - Routine 12](NSS-Shared-Functions-Other-Functions#settime)
      - [`SetTrapDetectedBy(oTrap, oDetector)` - Routine 550](NSS-Shared-Functions-Other-Functions#settrapdetectedby)
      ...
      - [`SWMG_AdjustFollowerHitPoints(oFollower, nHP, nAbsolute)` - Routine 590](NSS-Shared-Functions-Other-Functions#swmgadjustfollowerhitpoints)
      - [`SWMG_GetCameraFarClip()` - Routine 609](NSS-Shared-Functions-Other-Functions#swmggetcamerafarclip)
      - [`SWMG_GetCameraNearClip()` - Routine 608](NSS-Shared-Functions-Other-Functions#swmggetcameranearclip)
      - [`SWMG_GetEnemy(nEntry)` - Routine 613](NSS-Shared-Functions-Other-Functions#swmggetenemy)
      - [`SWMG_GetEnemyCount()` - Routine 612](NSS-Shared-Functions-Other-Functions#swmggetenemycount)
      - [`SWMG_GetGunBankBulletModel(oFollower, nGunBank)` - Routine 625](NSS-Shared-Functions-Other-Functions#swmggetgunbankbulletmodel)
      - [`SWMG_GetGunBankCount(oFollower)` - Routine 624](NSS-Shared-Functions-Other-Functions#swmggetgunbankcount)
      - [`SWMG_GetGunBankDamage(oFollower, nGunBank)` - Routine 627](NSS-Shared-Functions-Other-Functions#swmggetgunbankdamage)
      - [`SWMG_GetGunBankGunModel(oFollower, nGunBank)` - Routine 626](NSS-Shared-Functions-Other-Functions#swmggetgunbankgunmodel)
      - [`SWMG_GetGunBankHorizontalSpread(oEnemy, nGunBank)` - Routine 657](NSS-Shared-Functions-Other-Functions#swmggetgunbankhorizontalspread)
      - [`SWMG_GetGunBankInaccuracy(oEnemy, nGunBank)` - Routine 660](NSS-Shared-Functions-Other-Functions#swmggetgunbankinaccuracy)
      - [`SWMG_GetGunBankLifespan(oFollower, nGunBank)` - Routine 629](NSS-Shared-Functions-Other-Functions#swmggetgunbanklifespan)
      - [`SWMG_GetGunBankSensingRadius(oEnemy, nGunBank)` - Routine 659](NSS-Shared-Functions-Other-Functions#swmggetgunbanksensingradius)
      - [`SWMG_GetGunBankSpeed(oFollower, nGunBank)` - Routine 630](NSS-Shared-Functions-Other-Functions#swmggetgunbankspeed)
      - [`SWMG_GetGunBankTarget(oFollower, nGunBank)` - Routine 631](NSS-Shared-Functions-Other-Functions#swmggetgunbanktarget)
      - [`SWMG_GetGunBankTimeBetweenShots(oFollower, nGunBank)` - Routine 628](NSS-Shared-Functions-Other-Functions#swmggetgunbanktimebetweenshots)
      - [`SWMG_GetGunBankVerticalSpread(oEnemy, nGunBank)` - Routine 658](NSS-Shared-Functions-Other-Functions#swmggetgunbankverticalspread)
      - [`SWMG_GetHitPoints(oFollower)` - Routine 616](NSS-Shared-Functions-Other-Functions#swmggethitpoints)
      - [`SWMG_GetIsInvulnerable(oFollower)` - Routine 665](NSS-Shared-Functions-Other-Functions#swmggetisinvulnerable)
      - [`SWMG_GetLastBulletFiredDamage()` - Routine 595](NSS-Shared-Functions-Other-Functions#swmggetlastbulletfireddamage)
      - [`SWMG_GetLastBulletFiredTarget()` - Routine 596](NSS-Shared-Functions-Other-Functions#swmggetlastbulletfiredtarget)
      - [`SWMG_GetLastBulletHitDamage()` - Routine 587](NSS-Shared-Functions-Other-Functions#swmggetlastbullethitdamage)
      - [`SWMG_GetLastBulletHitPart()` - Routine 639](NSS-Shared-Functions-Other-Functions#swmggetlastbullethitpart)
      - [`SWMG_GetLastBulletHitShooter()` - Routine 589](NSS-Shared-Functions-Other-Functions#swmggetlastbullethitshooter)
      - [`SWMG_GetLastBulletHitTarget()` - Routine 588](NSS-Shared-Functions-Other-Functions#swmggetlastbullethittarget)
      - [`SWMG_GetLastEvent()` - Routine 583](NSS-Shared-Functions-Other-Functions#swmggetlastevent)
      - [`SWMG_GetLastEventModelName()` - Routine 584](NSS-Shared-Functions-Other-Functions#swmggetlasteventmodelname)
      - [`SWMG_GetLastFollowerHit()` - Routine 593](NSS-Shared-Functions-Other-Functions#swmggetlastfollowerhit)
      - [`SWMG_GetLastHPChange()` - Routine 606](NSS-Shared-Functions-Other-Functions#swmggetlasthpchange)
      - [`SWMG_GetLastObstacleHit()` - Routine 594](NSS-Shared-Functions-Other-Functions#swmggetlastobstaclehit)
      - [`SWMG_GetLateralAccelerationPerSecond()` - Routine 521](NSS-Shared-Functions-Other-Functions#swmggetlateralaccelerationpersecond)
      - [`SWMG_GetMaxHitPoints(oFollower)` - Routine 617](NSS-Shared-Functions-Other-Functions#swmggetmaxhitpoints)
      - [`SWMG_GetNumLoops(oFollower)` - Routine 621](NSS-Shared-Functions-Other-Functions#swmggetnumloops)
      - [`SWMG_GetObstacle(nEntry)` - Routine 615](NSS-Shared-Functions-Other-Functions#swmggetobstacle)
      - [`SWMG_GetObstacleCount()` - Routine 614](NSS-Shared-Functions-Other-Functions#swmggetobstaclecount)
      - [`SWMG_GetPosition(oFollower)` - Routine 623](NSS-Shared-Functions-Other-Functions#swmggetposition)
      - [`SWMG_GetSphereRadius(oFollower)` - Routine 619](NSS-Shared-Functions-Other-Functions#swmggetsphereradius)
      - [`SWMG_IsEnemy(oid)` - Routine 601](NSS-Shared-Functions-Other-Functions#swmgisenemy)
      - [`SWMG_IsFollower(oid)` - Routine 599](NSS-Shared-Functions-Other-Functions#swmgisfollower)
      - [`SWMG_IsGunBankTargetting(oFollower, nGunBank)` - Routine 640](NSS-Shared-Functions-Other-Functions#swmgisgunbanktargetting)
      - [`SWMG_IsObstacle(oid)` - Routine 603](NSS-Shared-Functions-Other-Functions#swmgisobstacle)
      - [`SWMG_IsTrigger(oid)` - Routine 602](NSS-Shared-Functions-Other-Functions#swmgistrigger)
      - [`SWMG_OnBulletHit()` - Routine 591](NSS-Shared-Functions-Other-Functions#swmgonbullethit)
      - [`SWMG_OnDamage()` - Routine 605](NSS-Shared-Functions-Other-Functions#swmgondamage)
      - [`SWMG_OnDeath()` - Routine 598](NSS-Shared-Functions-Other-Functions#swmgondeath)
      - [`SWMG_OnObstacleHit()` - Routine 592](NSS-Shared-Functions-Other-Functions#swmgonobstaclehit)
      - [`SWMG_RemoveAnimation(oObject, sAnimName)` - Routine 607](NSS-Shared-Functions-Other-Functions#swmgremoveanimation)
      - [`SWMG_SetCameraClip(fNear, fFar)` - Routine 610](NSS-Shared-Functions-Other-Functions#swmgsetcameraclip)
      - [`SWMG_SetFollowerHitPoints(oFollower, nHP)` - Routine 604](NSS-Shared-Functions-Other-Functions#swmgsetfollowerhitpoints)
      - [`SWMG_SetGunBankBulletModel(oFollower, nGunBank, sBulletModel)` - Routine 632](NSS-Shared-Functions-Other-Functions#swmgsetgunbankbulletmodel)
      - [`SWMG_SetGunBankDamage(oFollower, nGunBank, nDamage)` - Routine 634](NSS-Shared-Functions-Other-Functions#swmgsetgunbankdamage)
      - [`SWMG_SetGunBankGunModel(oFollower, nGunBank, sGunModel)` - Routine 633](NSS-Shared-Functions-Other-Functions#swmgsetgunbankgunmodel)
      - [`SWMG_SetGunBankHorizontalSpread(oEnemy, nGunBank, fHorizontalSpread)` - Routine 661](NSS-Shared-Functions-Other-Functions#swmgsetgunbankhorizontalspread)
      - [`SWMG_SetGunBankInaccuracy(oEnemy, nGunBank, fInaccuracy)` - Routine 664](NSS-Shared-Functions-Other-Functions#swmgsetgunbankinaccuracy)
      - [`SWMG_SetGunBankLifespan(oFollower, nGunBank, fLifespan)` - Routine 636](NSS-Shared-Functions-Other-Functions#swmgsetgunbanklifespan)
      - [`SWMG_SetGunBankSensingRadius(oEnemy, nGunBank, fSensingRadius)` - Routine 663](NSS-Shared-Functions-Other-Functions#swmgsetgunbanksensingradius)
      - [`SWMG_SetGunBankSpeed(oFollower, nGunBank, fSpeed)` - Routine 637](NSS-Shared-Functions-Other-Functions#swmgsetgunbankspeed)
      - [`SWMG_SetGunBankTarget(oFollower, nGunBank, nTarget)` - Routine 638](NSS-Shared-Functions-Other-Functions#swmgsetgunbanktarget)
      - [`SWMG_SetGunBankTimeBetweenShots(oFollower, nGunBank, fTBS)` - Routine 635](NSS-Shared-Functions-Other-Functions#swmgsetgunbanktimebetweenshots)
      - [`SWMG_SetGunBankVerticalSpread(oEnemy, nGunBank, fVerticalSpread)` - Routine 662](NSS-Shared-Functions-Other-Functions#swmgsetgunbankverticalspread)
      - [`SWMG_SetLateralAccelerationPerSecond(fLAPS)` - Routine 520](NSS-Shared-Functions-Other-Functions#swmgsetlateralaccelerationpersecond)
      - [`SWMG_SetMaxHitPoints(oFollower, nMaxHP)` - Routine 618](NSS-Shared-Functions-Other-Functions#swmgsetmaxhitpoints)
      - [`SWMG_SetNumLoops(oFollower, nNumLoops)` - Routine 622](NSS-Shared-Functions-Other-Functions#swmgsetnumloops)
      - [`SWMG_SetSphereRadius(oFollower, fRadius)` - Routine 620](NSS-Shared-Functions-Other-Functions#swmgsetsphereradius)
    ...
    - [Party Management](#party-management)
      ...
      - [`GetPartyAIStyle()` - Routine 704](NSS-Shared-Functions-Other-Functions#getpartyaistyle)
      - [`GetPartyMemberByIndex(nIndex)` - Routine 577](NSS-Shared-Functions-Other-Functions#getpartymemberbyindex)
      - [`GetPartyMemberCount()` - Routine 126](NSS-Shared-Functions-Other-Functions#getpartymembercount)
      ...
      - [`SetPartyAIStyle(nStyle)` - Routine 706](NSS-Shared-Functions-Other-Functions#setpartyaistyle)
      - [`SetPartyLeader(nNPC)` - Routine 13](NSS-Shared-Functions-Other-Functions#setpartyleader)
    ...
    - [Player Character Functions](#player-character-functions)
      ...
      - [`GetPCSpeaker()` - Routine 238](NSS-Shared-Functions-Other-Functions#getpcspeaker)
      ...
      - [`SWMG_GetPlayer()` - Routine 611](NSS-Shared-Functions-Other-Functions#swmggetplayer)
      - [`SWMG_GetPlayerAccelerationPerSecond()` - Routine 645](NSS-Shared-Functions-Other-Functions#swmggetplayeraccelerationpersecond)
      - [`SWMG_GetPlayerInvincibility()` - Routine 642](NSS-Shared-Functions-Other-Functions#swmggetplayerinvincibility)
      - [`SWMG_GetPlayerMaxSpeed()` - Routine 667](NSS-Shared-Functions-Other-Functions#swmggetplayermaxspeed)
      - [`SWMG_GetPlayerMinSpeed()` - Routine 644](NSS-Shared-Functions-Other-Functions#swmggetplayerminspeed)
      - [`SWMG_GetPlayerOffset()` - Routine 641](NSS-Shared-Functions-Other-Functions#swmggetplayeroffset)
      - [`SWMG_GetPlayerOrigin()` - Routine 655](NSS-Shared-Functions-Other-Functions#swmggetplayerorigin)
      - [`SWMG_GetPlayerSpeed()` - Routine 643](NSS-Shared-Functions-Other-Functions#swmggetplayerspeed)
      - [`SWMG_GetPlayerTunnelInfinite()` - Routine 717](NSS-Shared-Functions-Other-Functions#swmggetplayertunnelinfinite)
      - [`SWMG_GetPlayerTunnelNeg()` - Routine 653](NSS-Shared-Functions-Other-Functions#swmggetplayertunnelneg)
      - [`SWMG_GetPlayerTunnelPos()` - Routine 646](NSS-Shared-Functions-Other-Functions#swmggetplayertunnelpos)
      - [`SWMG_IsPlayer(oid)` - Routine 600](NSS-Shared-Functions-Other-Functions#swmgisplayer)
      - [`SWMG_SetPlayerAccelerationPerSecond(fAPS)` - Routine 651](NSS-Shared-Functions-Other-Functions#swmgsetplayeraccelerationpersecond)
      - [`SWMG_SetPlayerInvincibility(fInvincibility)` - Routine 648](NSS-Shared-Functions-Other-Functions#swmgsetplayerinvincibility)
      - [`SWMG_SetPlayerMaxSpeed(fMaxSpeed)` - Routine 668](NSS-Shared-Functions-Other-Functions#swmgsetplayermaxspeed)
      - [`SWMG_SetPlayerMinSpeed(fMinSpeed)` - Routine 650](NSS-Shared-Functions-Other-Functions#swmgsetplayerminspeed)
      - [`SWMG_SetPlayerOffset(vOffset)` - Routine 647](NSS-Shared-Functions-Other-Functions#swmgsetplayeroffset)
      - [`SWMG_SetPlayerOrigin(vOrigin)` - Routine 656](NSS-Shared-Functions-Other-Functions#swmgsetplayerorigin)
      - [`SWMG_SetPlayerSpeed(fSpeed)` - Routine 649](NSS-Shared-Functions-Other-Functions#swmgsetplayerspeed)
      - [`SWMG_SetPlayerTunnelInfinite(vInfinite)` - Routine 718](NSS-Shared-Functions-Other-Functions#swmgsetplayertunnelinfinite)
      - [`SWMG_SetPlayerTunnelNeg(vTunnel)` - Routine 654](NSS-Shared-Functions-Other-Functions#swmgsetplayertunnelneg)
      - [`SWMG_SetPlayerTunnelPos(vTunnel)` - Routine 652](NSS-Shared-Functions-Other-Functions#swmgsetplayertunnelpos)
    - [Skills and Feats](#skills-and-feats)
      ...
      - [`GetSkillRank(nSkill, oTarget)` - Routine 315](NSS-Shared-Functions-Other-Functions#getskillrank)
    ...
    - [Sound and Music Functions](#sound-and-music-functions)
      ...
      - [`PlaySound(sSoundName)` - Routine 46](NSS-Shared-Functions-Other-Functions#playsound)
      ...
      - [`SWMG_GetSoundFrequency(oFollower, nSound)` - Routine 683](NSS-Shared-Functions-Other-Functions#swmggetsoundfrequency)
      - [`SWMG_GetSoundFrequencyIsRandom(oFollower, nSound)` - Routine 685](NSS-Shared-Functions-Other-Functions#swmggetsoundfrequencyisrandom)
      - [`SWMG_GetSoundVolume(oFollower, nSound)` - Routine 687](NSS-Shared-Functions-Other-Functions#swmggetsoundvolume)
      - [`SWMG_PlayAnimation(oObject, sAnimName, bLooping, bQueue, bOverlay)` - Routine 586](NSS-Shared-Functions-Other-Functions#swmgplayanimation)
      - [`SWMG_SetSoundFrequency(oFollower, nSound, nFrequency)` - Routine 684](NSS-Shared-Functions-Other-Functions#swmgsetsoundfrequency)
      - [`SWMG_SetSoundFrequencyIsRandom(oFollower, nSound, bIsRandom)` - Routine 686](NSS-Shared-Functions-Other-Functions#swmgsetsoundfrequencyisrandom)
      - [`SWMG_SetSoundVolume(oFollower, nSound, nVolume)` - Routine 688](NSS-Shared-Functions-Other-Functions#swmgsetsoundvolume)
  ...
  - [TSL-Only Functions](#tsl-only-functions)
    ...
    - [Other Functions](#other-functions-2)
      ...
      - [`GetBonusForcePoints(oCreature)` - Routine 803](NSS-Shared-Functions-Other-Functions#getbonusforcepoints)
      - [`GetChemicalPieceValue()` - Routine 775](NSS-Shared-Functions-Other-Functions#getchemicalpiecevalue)
      - [`GetChemicals()` - Routine 774](NSS-Shared-Functions-Other-Functions#getchemicals)
      - [`GetHealTarget(oidHealer)`](#gethealtargetoidhealer)
      - [`GetInfluence(nNPC)` - Routine 795](NSS-Shared-Functions-Other-Functions#getinfluence)
      - [`GetIsPuppet(oPUP)`](#getispuppetopup)
      - [`GetIsXBox()`](#getisxbox)
      - [`GetLastForfeitViolation()`](#getlastforfeitviolation)
      - [`GetPUPOwner(oPUP)`](#getpupowneropup)
      - [`GetRacialSubType(oTarget)` - Routine 798](NSS-Shared-Functions-Other-Functions#getracialsubtype)
      - [`GetRandomDestination(oCreature, rangeLimit)`](#getrandomdestinationocreature-rangelimit)
      - [`GetScriptParameter(nIndex)` - Routine 768](NSS-Shared-Functions-Other-Functions#getscriptparameter)
      - [`GetScriptStringParameter()`](#getscriptstringparameter)
      - [`GetSpellAcquired(nSpell, oCreature)` - Routine 377](NSS-Shared-Functions-Other-Functions#getspellacquired)
      ...
      - [`SetBonusForcePoints(oCreature, nBonusFP)` - Routine 801](NSS-Shared-Functions-Other-Functions#setbonusforcepoints)
      ...
      - [`SetFadeUntilScript()` - Routine 769](NSS-Shared-Functions-Other-Functions#setfadeuntilscript)
      ...
      - [`SWMG_DestroyMiniGameObject(oObject)` - Routine 792](NSS-Shared-Functions-Other-Functions#swmgdestroyminigameobject)
      - [`SWMG_GetSwoopUpgrade(nSlot)` - Routine 782](NSS-Shared-Functions-Other-Functions#swmggetswoopupgrade)
      - [`SWMG_GetTrackPosition(oFollower)` - Routine 789](NSS-Shared-Functions-Other-Functions#swmggettrackposition)
      - [`SWMG_SetFollowerPosition(vPos)` - Routine 790](NSS-Shared-Functions-Other-Functions#swmgsetfollowerposition)
      - [`SWMG_SetJumpSpeed(fSpeed)` - Routine 804](NSS-Shared-Functions-Other-Functions#swmgsetjumpspeed)
    ...
    - [Skills and Feats](#skills-and-feats-1)
      ...
      - [`GetFeatAcquired(nFeat, oCreature)` - Routine 285](NSS-Shared-Functions-Other-Functions#getfeatacquired)
...
- `DataType`: Enumeration of all NWScript data types (INT, [float](GFF-File-Format#gff-data-types), string, OBJECT, vector, etc.)
...
- **[NCS File Format](NCS-File-Format.md)**: Compiled bytecode format that [NSS](NSS-File-Format) compiles to
