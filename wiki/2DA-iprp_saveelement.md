...
**Engine Usage**: Maps item property [values](GFF-File-Format#gff-data-types) to saving throw element [types](GFF-File-Format#gff-data-types). The engine uses this [file](GFF-File-Format) to determine saving throw element calculations for item properties.
