...
pykotorcli diff-installation --path1 "C:\Games\KOTOR" --path2 "C:\Games\KOTOR_Modded" --filter tat_m17ac --output-mode diff_only

# Generate incremental TSLPatcher output while diffing
pykotorcli diff-installation --path1 "C:\Games\KOTOR" --path2 "C:\Games\KOTOR_Modded" --tslpatchdata .\tslpatchdata --ini changes.ini --incremental

# GUI fallback (no args or explicit flag)
kotordiff
# or
pykotorcli diff-installation --gui
```
