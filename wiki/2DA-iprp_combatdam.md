...
**Engine Usage**: Maps item property [values](GFF-File-Format#gff-data-types) to combat damage bonuses. The engine uses this [file](GFF-File-Format) to determine damage bonus calculations for item properties.
