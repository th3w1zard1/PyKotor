...
**Engine Usage**: Maps item property [values](GFF-File-Format#gff-data-types) to immunity [types](GFF-File-Format#gff-data-types). The engine uses this [file](GFF-File-Format) to determine immunity calculations for item properties.
...
| Additional columns | Various | Immunity [type](GFF-File-Format#gff-data-types) mappings |
