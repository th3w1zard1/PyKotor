...
- [BWM File Format](BWM-File-Format) - Walkmesh format used by rooms
- [VIS File Format](VIS-File-Format) - Visibility format generated by builder
- [ERF File Format](ERF-File-Format) - Module archive format for output
- [GFF-ARE](GFF-ARE) - Area file format generated by builder
