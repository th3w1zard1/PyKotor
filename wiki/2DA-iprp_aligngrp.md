...
**Engine Usage**: Maps item property [values](GFF-File-Format#data-types) to alignment group restrictions. The engine uses this [file](GFF-File-Format) to determine alignment restrictions for item properties.
