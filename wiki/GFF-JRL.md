...
[JRL files](GFF-File-Format#jrl-journal) define the [structure](GFF-File-Format#file-structure-overview) of the player's [quest journal](GFF-File-Format#jrl-journal). They organize [quests](GFF-File-Format#jrl-journal) into categories and track progress through individual [journal entries](GFF-File-Format#jrl-journal).
...
## Quest [structure](GFF-File-Format#file-structure-overview)
...
- Dialogues use `Quest` and `QuestEntry` [fields](GFF-File-Format#file-structure-overview).
...
- **XP Rewards**: `XP_Percentage` scales the `journal.2da` XP [value](GFF-File-Format#gff-data-types) for the quest.
