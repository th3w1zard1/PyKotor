# KotOR [LYT files](LYT-File-Format) format Documentation
...
- [`vendor/xoreos/src/aurora/lytfile.cpp`](https://github.com/th3w1zard1/xoreos/blob/master/src/aurora/lytfile.cpp) - Generic Aurora [LYT](LYT-File-Format) implementation (shared format)
...
- [BWM File Format](BWM-File-Format) - Walkmeshes ([WOK](BWM-File-Format) files) loaded alongside [LYT](LYT-File-Format) rooms
...
- [Indoor Map Builder Implementation Guide](Indoor-Map-Builder-Implementation-Guide) - Uses [LYT](LYT-File-Format) format for generated modules
...
- The engine combines [LYT](LYT-File-Format) doorhook positions with [BWM](BWM-File-Format) transition data to create functional doorways
