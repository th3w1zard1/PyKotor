...
|------------|------|-------------|
| `label` | [string](GFF-File-Format#gff-data-types) | Spell label |
| `name` | [StrRef](TLK-File-Format#string-references-strref) | [string](GFF-File-Format#gff-data-types) reference for spell name |
...
| `targettype` | Integer | Target [type](GFF-File-Format#gff-data-types) [flags](GFF-File-Format#gff-data-types) |
...
| `projectiletype` | Integer | Projectile [type](GFF-File-Format#gff-data-types) identifier |
...
| `description` | [StrRef](TLK-File-Format#string-references-strref) | Spell description [string](GFF-File-Format#gff-data-types) reference |
| `altmessage` | StrRef (optional) | Alternative message [string](GFF-File-Format#gff-data-types) reference |
...
| `immunitytype` | Integer | Immunity [type](GFF-File-Format#gff-data-types) identifier |
...
- `name`: [string](GFF-File-Format#gff-data-types) reference for spell name
- `spelldesc`: [string](GFF-File-Format#gff-data-types) reference for spell description (note: column name is `spelldesc`, not `description`)
...
- [`Libraries/PyKotor/src/pykotor/extract/twoda.py:558-560`](https://github.com/th3w1zard1/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/extract/twoda.py#L558-L560) - [GFF](GFF-File-Format) [field](GFF-File-Format#file-structure-overview) mapping: "Subtype", "SpellId", and "Spell" -> [spells.2da](2DA-spells)
...
- [`vendor/KotOR.js/src/talents/TalentSpell.ts:16-44`](https://github.com/th3w1zard1/KotOR.js/blob/master/src/talents/TalentSpell.ts#L16-L44) - Spell [structure](GFF-File-Format#file-structure-overview) with additional columns
