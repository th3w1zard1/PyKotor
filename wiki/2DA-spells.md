...
**Engine Usage**: Defines all Force powers (and legacy spell entries) in KotOR, including their costs, targeting modes, visual effects, and descriptions. The engine uses this [file](GFF-File-Format) to determine Force power availability, casting requirements, and effects. Note: KotOR uses Force powers rather than traditional D&D spells, though the [file](GFF-File-Format) [structure](GFF-File-Format#file-structure) is inherited from the Aurora engine (originally designed for Neverwinter Nights).

**Row [index](2DA-File-Format#row-labels)**: Spell ID (integer)

**Column [structure](GFF-File-Format#file-structure)**:

| Column Name | [type](GFF-File-Format#data-types) | Description |
|------------|------|-------------|
| `label` | [string](GFF-File-Format#cexostring) | Spell label |
| `name` | [StrRef](TLK-File-Format#string-references-strref) | [string](GFF-File-Format#cexostring) reference for spell name |
| `school` | Integer | Spell school identifier |
| `range` | Integer | Spell range [type](GFF-File-Format#data-types) |
| `vs` | Integer | Versus type (self, touch, etc.) |
| `metamagic` | Integer | Metamagic [flags](GFF-File-Format#data-types) |
| `targettype` | Integer | Target [type](GFF-File-Format#data-types) [flags](GFF-File-Format#data-types) |
| `impactscript` | ResRef (optional) | Impact script [ResRef](GFF-File-Format#resref) |
...
| `hostilesetting` | Integer | Hostile setting [flags](GFF-File-Format#data-types) |
...
| `projectile` | ResRef (optional) | Projectile [model](MDL-MDX-File-Format) [ResRef](GFF-File-Format#resref) |
| `projectilesound` | ResRef (optional) | Projectile sound [ResRef](GFF-File-Format#resref) |
| `projectiletype` | Integer | Projectile [type](GFF-File-Format#data-types) identifier |
| `projectileorient` | Integer | Projectile [orientation](MDL-MDX-File-Format#node-header) |
| `projectilepath` | Integer | Projectile path [type](GFF-File-Format#data-types) |
| `projectilehoming` | Boolean | Whether projectile homes on target |
| `projectilemodel` | ResRef (optional) | Projectile 3D [model](MDL-MDX-File-Format) [ResRef](GFF-File-Format#resref) |
| `projectilemodel2` through `projectilemodel50` | ResRef (optional) | Additional projectile models (numbered 2-50) |
| `icon` | [ResRef](GFF-File-Format#resref) | Spell icon [ResRef](GFF-File-Format#resref) |
| `icon2` through `icon50` | ResRef (optional) | Additional icons (numbered 2-50) |
| `description` | [StrRef](TLK-File-Format#string-references-strref) | Spell description [string](GFF-File-Format#cexostring) reference |
| `altmessage` | StrRef (optional) | Alternative message [string](GFF-File-Format#cexostring) reference |
| `usewhencast` | Integer | Use when cast [flags](GFF-File-Format#data-types) |
| `blood` | Boolean | Whether spell causes blood effects |
| `concentration` | Integer | Concentration check DC |
| `immunitytype` | Integer | Immunity [type](GFF-File-Format#data-types) identifier |
| `immunitytype2` through `immunitytype50` | Integer (optional) | Additional immunity types (numbered 2-50) |
| `immunityitem` | Integer | Immunity item [type](GFF-File-Format#data-types) |
...
- `name`: [string](GFF-File-Format#cexostring) reference for spell name
- `spelldesc`: [string](GFF-File-Format#cexostring) reference for spell description (note: column name is `spelldesc`, not `description`)
...
- `hostilesetting`: Hostile setting [flags](GFF-File-Format#data-types)
- `projectile`: Projectile [ResRef](GFF-File-Format#resref)
- `projectileHook`: Projectile hook point
- `projectileOrigin`: Projectile origin point
- `projectileTarget`: Projectile target point
- `projectileCurve`: Projectile curve [type](GFF-File-Format#data-types)
- `projmodel`: Projectile [model](MDL-MDX-File-Format) [ResRef](GFF-File-Format#resref)
- `range`: Spell range
- `impactscript`: Impact script [ResRef](GFF-File-Format#resref)
- `casthandvisual`: Cast hand visual effect

**Note**: The `[spells.2da](2DA-spells)` [file](GFF-File-Format) contains many optional columns for projectile [models](MDL-MDX-File-Format), icons, and immunity types (numbered 1-50). These [ARE](GFF-File-Format#are-area) used for spell variations and visual effects.
...
- [`Libraries/PyKotor/src/pykotor/extract/twoda.py:239`](https://github.com/th3w1zard1/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/extract/twoda.py#L239) - Script [ResRef](GFF-File-Format#resref) column definition for [spells.2da](2DA-spells) (impactscript)
- [`Libraries/PyKotor/src/pykotor/extract/twoda.py:432`](https://github.com/th3w1zard1/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/extract/twoda.py#L432) - Script [ResRef](GFF-File-Format#resref) column definition for [spells.2da](2DA-spells) (K2: impactscript)
...
- [`Libraries/PyKotor/src/pykotor/extract/twoda.py:558-560`](https://github.com/th3w1zard1/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/extract/twoda.py#L558-L560) - [GFF](GFF-File-Format) [field](GFF-File-Format#file-structure) mapping: "Subtype", "SpellId", and "Spell" -> [spells.2da](2DA-spells)
...
- [`vendor/KotOR.js/src/talents/TalentSpell.ts:16-44`](https://github.com/th3w1zard1/KotOR.js/blob/master/src/talents/TalentSpell.ts#L16-L44) - Spell [structure](GFF-File-Format#file-structure) with additional columns
