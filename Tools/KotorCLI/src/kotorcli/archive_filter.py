"""Archive filtering helpers for KotorCLI.

KotorCLI users commonly think in terms of filenames like ``p_cand.utc`` rather than
...
def matches_resource_name(resref: str, ext: str, pattern: str) -> bool:
