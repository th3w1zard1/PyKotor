...
class ChangesIniGenerator:
    ...
    def __init__(self):
        # Common KOTOR file extensions for GFF files
        self.gff_extensions = {
    ...
    def _process_modified_file(self, change: FileChange, ini_sections: dict[str, Any]):
        ...
        resource_type = change.resource_type or self._detect_resource_type(change.path)
        
        if resource_type in self.gff_extensions:
    ...
    def _generate_ini_content(self, ini_sections: dict[str, Any]) -> str:
        ...
        output.write("ConfirmMessage=This mod was generated from a KOTOR installation diff using HoloGenerator.\n")
        output.write("ExecutableType=1\n")
        output.write("\n")
