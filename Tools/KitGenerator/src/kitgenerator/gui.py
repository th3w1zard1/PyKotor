...
class KitGeneratorApp(BaseApp):
    ...
    def __init__(self):
        ...
        super().__init__(
            title="PyKotor CLI Kit Generator",
    ...
    def on_installation_paths_chosen(
        ...
        def _move_cursor_to_end(widget: ttk.Combobox):
            self.move_cursor_to_end(widget)

        self.root.after(10, _move_cursor_to_end, cast("ttk.Combobox", event.widget))
    ...
    def browse_installation(
        ...
        try:
            ...
            if not directory_path_str:
                return
            directory: CaseAwarePath = CaseAwarePath(directory_path_str)
            ...
            if self.installation_paths is not None:
                ...
                self.root.after(10, _move_cursor_to_end_installation_paths)
            self.populate_modules()
    ...
    def begin_extract(self):
        ...
        try:
            ...
            self.start_task_thread(self.begin_extract_thread, args=(self.simple_thread_event,), name="PyKotor_kit_extract_thread")
        except Exception as exc:  # noqa: BLE001
        ...
        try:
            ...
            class LoggerBridge(logging.Handler):
                def __init__(
                    ...
                    super().__init__()
                    self.patch_logger: PatchLogger = patch_logger
    ...
    def show_onboarding_info(self):
        ...
        onboarding_text = f"""PyKotor CLI Kit Generator v{VERSION_LABEL}
{"=" * 80}
