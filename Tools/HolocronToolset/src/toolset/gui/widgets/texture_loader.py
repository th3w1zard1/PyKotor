...
class TextureLoaderProcess(multiprocessing.Process):
    ...
    def __init__(
        ...
        Args:
            ...
            result_queue: Queue to send loaded textures to (as serialized bytes)
        """
