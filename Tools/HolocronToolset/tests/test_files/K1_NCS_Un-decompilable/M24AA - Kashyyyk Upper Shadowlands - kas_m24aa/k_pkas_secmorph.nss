...
// Globals
	...
	int intGLOB_27 = 0;
	object objectGLOB_1;
	intGLOB_27 = action_200("Rulan", 0);
	object objectGLOB_2;
	intGLOB_27 = action_548();
	object objectGLOB_3;
	intGLOB_27 = action_577(1);
	object objectGLOB_4;
	intGLOB_27 = action_577(2);
	int intGLOB_28 = 1;
	int intGLOB_29 = 2;
	int intGLOB_30 = 3;
	int intGLOB_31 = 4;
...
void sub2(string stringParam1, location locationParam2, int intParam3, int intParam4);
...
void sub2(string stringParam1, location locationParam2, int intParam3, int intParam4) {
	...
	location location1 = GetLocation(GetObjectByTag("kas_rulan_morph_jump_wp2", 0));
	if ((intParam3 == 1)) {
		int1 = 1047;
	}
	else {
	...
	AssignCommand(object1, PlayAnimation(10, 0.1, 7.0));
	DelayCommand(0.2, ApplyEffectAtLocation(0, EffectVisualEffect(int1, 0), locationParam2, 0.0));
	DelayCommand(0.8, ApplyEffectToObject(2, EffectDisguise(353), object1, 0.0));
	DelayCommand(3.0, PlaySound("v_pro_afflict"));
	DelayCommand(0.5, ApplyEffectAtLocation(0, EffectVisualEffect(int1, 0), locationParam2, 0.0));
	DelayCommand(1.4499999, ApplyEffectAtLocation(0, EffectVisualEffect(int1, 0), locationParam2, 0.0));
	DelayCommand(2.3, ApplyEffectToObject(0, EffectVisualEffect(6002, 0), GetFirstPC(), 0.0));
	DelayCommand(2.3, PlaySound("c_terantank_bat1"));
	DelayCommand(1.8, AssignCommand(object1, JumpToLocation(locationParam2)));
}
...
void main() {
	string string1;
	location location1 = GetLocation(GetObjectByTag("kas_rulan_fake_wp", 0));
	location location3;
	...
	location3 = GetLocation(GetObjectByTag(string1, 0));
	AssignCommand(GetObjectByTag(string1, 0), JumpToLocation(location1));
	sub1(8.2);
	DelayCommand(2.6, sub2(string1, location1, 0, 0));
	DelayCommand(4.2, SetDialogPlaceableCamera(32));
	DelayCommand(8.1, AssignCommand(GetObjectByTag(string1, 0), JumpToLocation(location3)));
	DelayCommand(8.2, ChangeToStandardFaction(GetObjectByTag("rulan_ter", 0), 1));
