        ...
        for kit_idx, kit in enumerate(complete_kits):
            for comp_idx, comp in enumerate(kit.components):
                ...
                for face in wok.faces:
                    ...
                    assert all(math.isfinite(v.x) and math.isfinite(v.y) and math.isfinite(v.z) for v in [face.v1, face.v2, face.v3]), (
                        f"All vertices should have finite coordinates for kit {kit.name}, component {comp.name}"
                    )

                    # Check vertices are not NaN
                    assert not any(math.isnan(v.x) or math.isnan(v.y) or math.isnan(v.z) for v in [face.v1, face.v2, face.v3]), (
...
class TestModuleKitBWMCentering:
    ...
    def test_module_kit_image_hitbox_congruent(self, qtbot: QtBot, builder_no_kits: IndoorMapBuilder, installation: HTInstallation):
    ...
    def test_module_kit_room_placement_and_selection(self, qtbot: QtBot, builder_no_kits: IndoorMapBuilder, installation: HTInstallation):
    ...
    def test_module_kit_no_black_buffer_zone(self, qtbot: QtBot, builder_no_kits: IndoorMapBuilder, installation: HTInstallation):
    ...
    def test_module_kit_rooms_snap_together(self, qtbot: QtBot, builder_no_kits: IndoorMapBuilder, installation: HTInstallation):
...
class TestModuleKitMouseDragAndConnect:
    ...
    def test_drag_module_room_with_mouse_no_black_buffer(self, qtbot: QtBot, builder_no_kits: IndoorMapBuilder, installation: HTInstallation):
    ...
    def test_module_room_has_connectors(self, qtbot: QtBot, builder_no_kits: IndoorMapBuilder, installation: HTInstallation):
    ...
    def test_preview_image_different_from_placed(self, qtbot: QtBot, builder_no_kits: IndoorMapBuilder, installation: HTInstallation):
    ...
    def test_drag_second_room_and_connect(self, qtbot: QtBot, builder_no_kits: IndoorMapBuilder, installation: HTInstallation):
    ...
    def test_cyan_connector_indicator_appears(self, qtbot: QtBot, builder_no_kits: IndoorMapBuilder, installation: HTInstallation):
    ...
    def test_snap_threshold_and_behavior(self, qtbot: QtBot, builder_no_kits: IndoorMapBuilder, installation: HTInstallation):
    ...
    def test_drag_room_with_mouse_actually_moves(self, qtbot: QtBot, builder_no_kits: IndoorMapBuilder, installation: HTInstallation):
