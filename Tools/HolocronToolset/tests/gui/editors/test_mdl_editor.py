...
def test_mdl_editor_new_file_creation(qtbot: QtBot, installation: HTInstallation):
...
def test_mdl_editor_initialization(qtbot: QtBot, installation: HTInstallation):
...
def test_mdl_editor_build_new_file(qtbot: QtBot, installation: HTInstallation):
...
def test_mdl_editor_clear_model(qtbot: QtBot, installation: HTInstallation):
...
def test_mdl_editor_load_requires_mdx(qtbot: QtBot, installation: HTInstallation):
...
def test_mdl_editor_load_method_signature(qtbot: QtBot, installation: HTInstallation):
...
def test_mdl_editor_model_renderer_initialization(qtbot: QtBot, installation: HTInstallation):
...
def test_mdl_editor_ui_elements(qtbot: QtBot, installation: HTInstallation):
...
def test_mdl_editor_signal_setup(qtbot: QtBot, installation: HTInstallation):
...
def test_mdl_editor_build_returns_tuple(qtbot: QtBot, installation: HTInstallation):
...
def test_mdl_editor_build_multiple_times(qtbot: QtBot, installation: HTInstallation):
...
def test_mdl_editor_new_resets_model(qtbot: QtBot, installation: HTInstallation):
...
def test_mdl_editor_new_clears_renderer(qtbot: QtBot, installation: HTInstallation):
...
def test_mdl_editor_empty_mdl_object(qtbot: QtBot, installation: HTInstallation):
...
def test_mdl_editor_without_installation(qtbot: QtBot):
...
def test_mdl_editor_menus_setup(qtbot: QtBot, installation: HTInstallation):
...
def test_mdl_editor_supported_resource_types(qtbot: QtBot, installation: HTInstallation):
...
def test_mdl_editor_load_mdl_method(qtbot: QtBot, installation: HTInstallation):
...
def test_mdl_editor_full_workflow(qtbot: QtBot, installation: HTInstallation):
...
def test_mdl_editor_multiple_new_calls(qtbot: QtBot, installation: HTInstallation):
