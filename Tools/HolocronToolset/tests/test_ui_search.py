...
def test_search_dialog_all_widgets_exist(qtbot: QtBot, installation: HTInstallation):
...
def test_search_dialog_all_checkboxes_exhaustive(qtbot: QtBot, installation: HTInstallation):
...
def test_search_dialog_all_radio_buttons(qtbot: QtBot, installation: HTInstallation):
...
def test_search_dialog_query_construction_exhaustive(qtbot: QtBot, installation: HTInstallation):
    ...
    if dialog.ui.typeARECheck.isChecked():
        check_types.append(ResourceType.ARE)
    if dialog.ui.typeGITCheck.isChecked():
        check_types.append(ResourceType.GIT)
    if dialog.ui.typeIFOCheck.isChecked():
        check_types.append(ResourceType.IFO)
    if dialog.ui.typeVISCheck.isChecked():
        check_types.append(ResourceType.VIS)
    if dialog.ui.typeLYTCheck.isChecked():
        check_types.append(ResourceType.LYT)
    if dialog.ui.typeDLGCheck.isChecked():
        check_types.append(ResourceType.DLG)
    if dialog.ui.typeJRLCheck.isChecked():
        check_types.append(ResourceType.JRL)
    if dialog.ui.typeUTCCheck.isChecked():
        check_types.append(ResourceType.UTC)
    if dialog.ui.typeUTDCheck.isChecked():
        check_types.append(ResourceType.UTD)
    if dialog.ui.typeUTECheck.isChecked():
        check_types.append(ResourceType.UTE)
    if dialog.ui.typeUTICheck.isChecked():
        check_types.append(ResourceType.UTI)
    if dialog.ui.typeUTPCheck.isChecked():
        check_types.append(ResourceType.UTP)
    if dialog.ui.typeUTMCheck.isChecked():
        check_types.append(ResourceType.UTM)
    if dialog.ui.typeUTSCheck.isChecked():
        check_types.append(ResourceType.UTS)
    if dialog.ui.typeUTTCheck.isChecked():
        check_types.append(ResourceType.UTT)
    if dialog.ui.typeUTWCheck.isChecked():
        check_types.append(ResourceType.UTW)
    if dialog.ui.type2DACheck.isChecked():
        check_types.append(ResourceType.TwoDA)
    if dialog.ui.typeNSSCheck.isChecked():
        check_types.append(ResourceType.NSS)
    if dialog.ui.typeNCSCheck.isChecked():
        check_types.append(ResourceType.NCS)
...
def test_search_dialog_installation_selector(qtbot: QtBot, installation: HTInstallation):
...
def test_search_dialog_text_input(qtbot: QtBot, installation: HTInstallation):
...
def test_results_dialog_all_widgets(qtbot: QtBot, installation: HTInstallation):
    ...
    signal_called: list[FileResource] = []
...
def test_results_dialog_empty_results(qtbot: QtBot, installation: HTInstallation):
...
def test_results_dialog_single_result(qtbot: QtBot, installation: HTInstallation):
