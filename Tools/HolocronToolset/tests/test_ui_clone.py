...
def test_clone_module_dialog_all_widgets_exist(qtbot: QtBot, installation: HTInstallation):
...
def test_clone_module_dialog_all_widgets_interactions(qtbot: QtBot, installation: HTInstallation):
...
def test_clone_module_dialog_parameter_collection(qtbot: QtBot, installation: HTInstallation):
...
def test_clone_module_dialog_buttons(qtbot: QtBot, installation: HTInstallation):
...
def test_clone_module_dialog_validation_edge_cases(qtbot: QtBot, installation: HTInstallation):
...
def test_clone_module_dialog_module_root_readonly(qtbot: QtBot, installation: HTInstallation):
