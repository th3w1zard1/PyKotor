...
def test_utmeditor_editor_help_dialog_opens_correct_file(qtbot, installation: HTInstallation):
    ...
    # Trigger help dialog with the correct file for UTMEditor
    editor._show_help_dialog("GFF-UTM.md")
