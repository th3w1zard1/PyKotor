...
def test_lyteditor_editor_help_dialog_opens_correct_file(qtbot, installation: HTInstallation):
    """Test that LYTEditor help dialog opens and displays the correct help file (not 'Help File Not Found')."""
    from toolset.gui.dialogs.editor_help import EditorHelpDialog
    
    editor = LYTEditor(None, installation)
    qtbot.addWidget(editor)
    
    # Trigger help dialog with the correct file for LYTEditor
    editor._show_help_dialog("LYT-File-Format.md")
    ...
    assert "Help File Not Found" not in html, \
        f"Help file 'LYT-File-Format.md' should be found, but error was shown. HTML: {html[:500]}"
