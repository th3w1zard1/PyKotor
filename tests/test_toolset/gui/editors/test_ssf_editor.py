...
def test_ssfeditor_editor_help_dialog_opens_correct_file(qtbot, installation: HTInstallation):
    """Test that SSFEditor help dialog opens and displays the correct help file (not 'Help File Not Found')."""
