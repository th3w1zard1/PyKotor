...
def test_utteditor_editor_help_dialog_opens_correct_file(qtbot, installation: HTInstallation):
    """Test that UTTEditor help dialog opens and displays the correct help file (not 'Help File Not Found')."""
    from toolset.gui.dialogs.editor_help import EditorHelpDialog
    
    editor = UTTEditor(None, installation)
    qtbot.addWidget(editor)
    
    # Trigger help dialog with the correct file for UTTEditor
    editor._show_help_dialog("GFF-UTT.md")
    ...
    assert "Help File Not Found" not in html, \
        f"Help file 'GFF-UTT.md' should be found, but error was shown. HTML: {html[:500]}"
