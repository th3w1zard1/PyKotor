...
**Conclusion**: Our implementation matches actual game files. xoreos and kotor.js have bugs in their parsers.
...
1. **No changes needed** for LYT doorhook format - our implementation is correct
2. **Document vendor bugs** in wiki for future reference
3. **Test generated modules** in actual game to validate kit/component system
4. **Add validation tests** for hook position calculations and door insertions
