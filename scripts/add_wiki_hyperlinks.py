...
REPLACEMENT_RULES.extend([
    ...
    ReplacementRule(r"\bheader\b(?!\s*\([^)]*\))", "[header](GFF-File-Format#file-header)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bheaders\b(?!\s*\([^)]*\))", "[headers](GFF-File-Format#file-header)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\boffset\b(?!\s*\([^)]*\))", "[offset](GFF-File-Format#file-structure)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\boffsets\b(?!\s*\([^)]*\))", "[offsets](GFF-File-Format#file-structure)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bpointer\b(?!\s*\([^)]*\))", "[pointer](GFF-File-Format#file-structure)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bpointers\b(?!\s*\([^)]*\))", "[pointers](GFF-File-Format#file-structure)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bcount\b(?!\s*\([^)]*\))", "[count](GFF-File-Format#file-structure)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bsize\b(?!\s*\([^)]*\))", "[size](GFF-File-Format#file-structure)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\btype\b(?!\s*\([^)]*\))", "[type](GFF-File-Format#data-types)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\btypes\b(?!\s*\([^)]*\))", "[types](GFF-File-Format#data-types)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bindex\b(?!\s*\([^)]*\))", "[index](2DA-File-Format#row-labels)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bindexes\b(?!\s*\([^)]*\))", "[indexes](2DA-File-Format#row-labels)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bindices\b(?!\s*\([^)]*\))", "[indices](2DA-File-Format#row-labels)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bflag\b(?!\s*\([^)]*\))", "[flag](GFF-File-Format#data-types)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bflags\b(?!\s*\([^)]*\))", "[flags](GFF-File-Format#data-types)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bbit\b(?!\s*\([^)]*\))", "[bit](GFF-File-Format#data-types)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bbits\b(?!\s*\([^)]*\))", "[bits](GFF-File-Format#data-types)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bmask\b(?!\s*\([^)]*\))", "[mask](GFF-File-Format#data-types)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bmasks\b(?!\s*\([^)]*\))", "[masks](GFF-File-Format#data-types)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bbitmask\b(?!\s*\([^)]*\))", "[bitmask](GFF-File-Format#data-types)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bbitmasks\b(?!\s*\([^)]*\))", "[bitmasks](GFF-File-Format#data-types)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\barray\b(?!\s*\([^)]*\))", "[array](2DA-File-Format)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\barrays\b(?!\s*\([^)]*\))", "[arrays](2DA-File-Format)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bstring\b(?!\s*\([^)]*\))", "[string](GFF-File-Format#cexostring)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bstrings\b(?!\s*\([^)]*\))", "[strings](GFF-File-Format#cexostring)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bvalue\b(?!\s*\([^)]*\))", "[value](GFF-File-Format#data-types)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bvalues\b(?!\s*\([^)]*\))", "[values](GFF-File-Format#data-types)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bfield\b(?!\s*\([^)]*\))", "[field](GFF-File-Format#file-structure)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bfields\b(?!\s*\([^)]*\))", "[fields](GFF-File-Format#file-structure)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bquaternion\b(?!\s*\([^)]*\))", "[quaternion](MDL-MDX-File-Format#node-header)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bquaternions\b(?!\s*\([^)]*\))", "[quaternions](MDL-MDX-File-Format#node-header)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bvector\b(?!\s*\([^)]*\))", "[vector](GFF-File-Format#vector)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bvectors\b(?!\s*\([^)]*\))", "[vectors](GFF-File-Format#vector)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bmatrix\b(?!\s*\([^)]*\))", "[matrix](BWM-File-Format#vertex-data-processing)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bmatrices\b(?!\s*\([^)]*\))", "[matrices](BWM-File-Format#vertex-data-processing)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bcoordinate\b(?!\s*\([^)]*\))", "[coordinate](GFF-File-Format#are-area)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bcoordinates\b(?!\s*\([^)]*\))", "[coordinates](GFF-File-Format#are-area)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bposition\b(?!\s*\([^)]*\))", "[position](MDL-MDX-File-Format#node-header)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bpositions\b(?!\s*\([^)]*\))", "[positions](MDL-MDX-File-Format#node-header)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\borientation\b(?!\s*\([^)]*\))", "[orientation](MDL-MDX-File-Format#node-header)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\borientations\b(?!\s*\([^)]*\))", "[orientations](MDL-MDX-File-Format#node-header)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\brotation\b(?!\s*\([^)]*\))", "[rotation](MDL-MDX-File-Format#node-header)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\brotations\b(?!\s*\([^)]*\))", "[rotations](MDL-MDX-File-Format#node-header)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\btransformation\b(?!\s*\([^)]*\))", "[transformation](BWM-File-Format#vertex-data-processing)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\btransformations\b(?!\s*\([^)]*\))", "[transformations](BWM-File-Format#vertex-data-processing)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bscale\b(?!\s*\([^)]*\))", "[scale](MDL-MDX-File-Format#node-header)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bcolor\b(?!\s*\([^)]*\))", "[color](GFF-File-Format#color)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bcolors\b(?!\s*\([^)]*\))", "[colors](GFF-File-Format#color)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bformat\b(?!\s*\([^)]*\))", "[format](GFF-File-Format)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bformats\b(?!\s*\([^)]*\))", "[formats](GFF-File-Format)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bfile\b(?!\s*\([^)]*\))", "[file](GFF-File-Format)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bfiles\b(?!\s*\([^)]*\))", "[files](GFF-File-Format)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bdata\b(?!\s*\([^)]*\))", "[data](GFF-File-Format#file-structure)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bstructure\b(?!\s*\([^)]*\))", "[structure](GFF-File-Format#file-structure)", LinkCategory.TECHNICAL_TERMS, priority=5),
    ReplacementRule(r"\bstructures\b(?!\s*\([^)]*\))", "[structures](GFF-File-Format#file-structure)", LinkCategory.TECHNICAL_TERMS, priority=5),
])
