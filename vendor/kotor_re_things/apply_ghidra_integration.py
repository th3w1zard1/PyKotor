...
from integrate_kotor_re_things import parse_xml_functions, parse_xml_symbols, parse_xml_data_definitions, parse_xml_comments


def save_parsed_data(output_path: Path, functions: List[Dict], symbols: List[Dict], data_defs: List[Dict], comments: List[Dict]):
    """Save parsed data to JSON for later processing."""
    data = {"functions": functions, "symbols": symbols, "data_definitions": data_defs, "comments": comments}
